...
public abstract class InvokeDialog extends InspectorSubFrame {
    ...
    public InvokeDialog(final String title, final String invokeLabel, final ObjectMetaData object, final Object pk,
        ...
        getContentPane().add(new JScrollPane(paramForm, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
