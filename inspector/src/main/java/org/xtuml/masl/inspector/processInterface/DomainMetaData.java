...
public abstract class DomainMetaData
    implements Comparable<DomainMetaData>
{
  ...
  public Node getXMLSchema ( final Document document, final boolean refIntegrityCheck, final boolean uniqueIdentifierCheck )
  {
    final Element schema = document.createElementNS(XMLConstants.W3C_XML_SCHEMA_NS_URI, "xs:schema");
    schema.setAttributeNS(XMLConstants.XMLNS_ATTRIBUTE_NS_URI,
                          XMLConstants.XMLNS_ATTRIBUTE + ":xs",
