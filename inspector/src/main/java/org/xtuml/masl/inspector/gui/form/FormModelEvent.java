...
public class FormModelEvent extends EventObject
{
   ...
   * the field names, types and order may have changed, depending on the value
   * of <code>structureChanged</code>
   */
   ...
   * <I>field</I> refers to the field index of the cell in the model's
   * co-ordinate system. When <I>field</I> is ALL_FIELDS, all cells in the
  ...
  /**
   * Returns the field for the event. If the return value is ALL_FIELDS; it
   * means every field changed.
   */
  public int getField ()
  {
    return field;
