...
public abstract class ExecutableSourceList<Dependent extends ExecutableSource, Discriminant>
        extends DependentObjectList<Dependent, Discriminant> implements PopupMenuListener {
    ...
    protected void initPopup() {
        ...
        setBreakpointItem.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(final ActionEvent action) {
                BreakpointController.getInstance().setBreakpoint(
                        ((ExecutableSource) getSelectedValue()).getSourcePosition(SourcePosition.FIRST_LINE));
            }
        });
        ...
        clearBreakpointItem.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(final ActionEvent action) {
                BreakpointController.getInstance().clearBreakpoint(
                        ((ExecutableSource) getSelectedValue()).getSourcePosition(SourcePosition.FIRST_LINE));
            }
        });
        ...
        removeBreakpointItem.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(final ActionEvent action) {
                BreakpointController.getInstance().removeBreakpoint(
                        ((ExecutableSource) getSelectedValue()).getSourcePosition(SourcePosition.FIRST_LINE));
            }
        });
    ...
    public void popupMenuWillBecomeVisible(final PopupMenuEvent e) {
        final boolean breakpointSet = BreakpointController.getInstance()
                .breakpointSet(((ExecutableSource) getSelectedValue()).getSourcePosition(SourcePosition.FIRST_LINE));
        final boolean breakpointExists = BreakpointController.getInstance()
                .breakpointExists(((ExecutableSource) getSelectedValue()).getSourcePosition(SourcePosition.FIRST_LINE));
    ...
    public Dimension getPreferredScrollableViewportSize() {
        ...
        d.width = getCellRenderer().getListCellRendererComponent(this,
                "WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW", 0, true, true)
