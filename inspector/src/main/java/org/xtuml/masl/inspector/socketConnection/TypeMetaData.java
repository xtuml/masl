...
public class TypeMetaData extends org.xtuml.masl.inspector.processInterface.TypeMetaData
    implements ReadableObject
{

  // Types must be in same order as the type enumerate in the
  // metadata header
  private static final BasicType typeDecoder[] = new BasicType[]
                                                 { BasicType.AnyInstance,
                                                 BasicType.Boolean,
                                                 BasicType.Byte,
                                                 BasicType.Character,
                                                 BasicType.Device,
