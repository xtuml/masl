...
public class ObjectList extends DependentObjectList<ObjectMetaData, DomainMetaData> {
    ...
    private class InstanceCounter implements PopupMenuListener {
        ...
        public void popupMenuWillBecomeVisible(final PopupMenuEvent e) {
            ...
            final Thread counter = new Thread() {
                ...
                public void run() {
                    try {
                        final int count = ProcessConnection.getConnection()
                                .getInstanceCount((ObjectMetaData) getSelectedValue());
