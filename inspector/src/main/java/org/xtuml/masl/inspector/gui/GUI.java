...
public class GUI
{
  ...
  public static void installUI ()
  {
    ...
    System.setProperty("swing.plaf.metal.smallFont", Preferences.getFontName() + "-" + (Preferences.getFontSize() - 2));

    if ( UIManager.getLookAndFeel() instanceof javax.swing.plaf.metal.MetalLookAndFeel )
    {
      UIManager.put("List.font", new UIDefaults.ProxyLazyValue(
                                                               "javax.swing.plaf.metal.MetalLookAndFeel",
                                                               "getControlTextFont"));
      UIManager.put("Panel.font", new UIDefaults.ProxyLazyValue(
                                                                "javax.swing.plaf.metal.MetalLookAndFeel",
                                                                "getControlTextFont"));
