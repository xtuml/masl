...
class InstanceTable extends com.jrefinery.ui.SortableTable implements UpdateListener {
    ...
    private class InstanceServiceInvoker implements ActionListener {
        ...
        public void actionPerformed(final ActionEvent action) {
            ...
            for (final int row : rows) {
                ...
                // TODO add listener
                /*
                 * dialog.addInvokeListener( new InvokeObjectServiceDialog.InvokeListener(){
                 * invoked() { model.refreshRow(row) } });
                 */
            }
        }
    }
