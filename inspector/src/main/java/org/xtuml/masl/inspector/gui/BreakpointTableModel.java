...
class BreakpointTableModel extends AutoSizingTableModel implements BreakpointListener {
    ...
    private static final Class<?>[] columnClasses = new Class<?>[] { Boolean.class, String.class, String.class };
    private static final String[] columnNames = new String[] { "", "Name", "Line" };
