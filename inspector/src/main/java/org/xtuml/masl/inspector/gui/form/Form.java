...
public class Form extends JPanel implements FormModelListener {
    ...
    public static class VoidEditor implements FormValueEditor {
    ...
    public static class EnumEditor implements FormValueEditor {
    ...
    public static class GenericEditor implements FormValueEditor {
    ...
    public static class StringEditor implements FormValueEditor {
        ...
        public StringEditor(final FormModel model, final int fieldNo) {
            ...
            if (getModel().isValueEditable(fieldNo)) {
                ...
                component = new JScrollPane(textArea, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
    ...
    public static void main(final String[] args) {
        final FormModel model = new AbstractFormModel() {
            ...
            private final Class<?>[] classes = new Class[] { Void.class, Integer.class, Double.class, String.class,
                    Boolean.class, Date.class, Enum.class, String.class, String.class };
            private final Object[] values = new Object[] { null, 500, 123.456, "Hello", true,
                    Calendar.getInstance().getTime(), Month.March,
