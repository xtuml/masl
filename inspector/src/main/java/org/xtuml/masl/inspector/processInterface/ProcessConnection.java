    ...
    implements BreakpointListener
{
  ...
  {
    checkCapability(Capability.TRACE_LINES, "setTraceLines", new Class[]
      { boolean.class });
    checkCapability(Capability.TRACE_BLOCKS, "setTraceBlocks", new Class[]
      { boolean.class });
    checkCapability(Capability.TRACE_EVENTS, "setTraceEvents", new Class[]
      { boolean.class });
    checkCapability(Capability.TRACE_EXCEPTIONS, "setTraceExceptions", new Class[]
      { boolean.class });
    checkCapability(Capability.STEP_LINES, "setStepLines", new Class[]
      { boolean.class });
    checkCapability(Capability.STEP_BLOCKS, "setStepBlocks", new Class[]
      { boolean.class });
    checkCapability(Capability.STEP_EXCEPTIONS, "setStepExceptions", new Class[]
      { boolean.class });
    checkCapability(Capability.STEP_EVENTS, "setStepEvents", new Class[]
      { boolean.class });
    checkCapability(Capability.ENABLE_TIMERS, "setEnableTimers", new Class[]
      { boolean.class });
    checkCapability(Capability.CATCH_CONSOLE, "setCatchConsole", new Class[]
      { boolean.class });
    ...
    checkCapability(Capability.SET_BREAKPOINT, "setBreakpoint", new Class[]
      { SourcePosition.class, Boolean.class });
    ...
    if ( System.getProperty("allowWrites", "true").equals("true") )
    {
      ...
      checkCapability(Capability.RUN_EXTERNAL, "runExternal", new Class[]
                                                                        { DomainServiceMetaData.class });
      checkCapability(Capability.RUN_DOMAIN_SERVICE, "invokeDomainService", new Class[]
                                                                        { DomainServiceMetaData.class,
                                                                            DataValue[].class });
      checkCapability(Capability.RUN_TERMINATOR_SERVICE, "invokeTerminatorService", new Class[]
                                                                        { TerminatorServiceMetaData.class,
                                                                            DataValue[].class });
      checkCapability(Capability.RUN_OBJECT_SERVICE, "invokeObjectService", new Class[]
                                                                        { ObjectServiceMetaData.class,
                                                                            Integer.class, DataValue[].class });
      checkCapability(Capability.RUN_TEST_SCHEDULE, "runTestSchedule", new Class[]
                                                                                 { java.io.File.class });
      checkCapability(Capability.FIRE_EVENT, "fireEvent", new Class[]
                                                                        { EventMetaData.class,
                                                                            ObjectMetaData.class,
                                                                            Integer.class,
                                                                            DataValue[].class });
      checkCapability(Capability.SCHEDULE_EVENT,
                      "scheduleEvent",
                      new Class[]
                      { TimerData.class });
      checkCapability(Capability.CANCEL_TIMER,
                      "cancelTimer",
                      new Class[]
                     { TimerData.class });
      checkCapability(Capability.CREATE_INSTANCE_POPULATION, "createInstancePopulation", new Class[]
                                                                                                   { ObjectMetaData.class,
                                                                                                       InstanceData[].class });
      checkCapability(Capability.CREATE_SINGLE_INSTANCE, "createSingleInstance", new Class[]
                                                                                                   { ObjectMetaData.class,
                                                                                                       InstanceData.class });
      checkCapability(Capability.UPDATE_SINGLE_INSTANCE, "updateSingleInstance", new Class[]
                                                                                                   { ObjectMetaData.class,
                                                                                                       InstanceData.class });
      checkCapability(Capability.DELETE_SINGLE_INSTANCE,
                      "deleteSingleInstance",
                                                                                                                 new Class[]
                                                                                                                   {  ObjectMetaData.class,
                                                                                                                       Object.class });
      checkCapability(Capability.CREATE_RELATIONSHIPS, "createRelationships", new Class[]
                                                                                                   { RelationshipMetaData.class,
                                                                                                       RelationshipData[].class });
      checkCapability(Capability.CREATE_SUPERSUBTYPES, "createSuperSubtypes", new Class[]
                                                                                                   { SuperSubtypeMetaData.class,
                                                                                                       SuperSubtypeData[].class });
  ...
  @SuppressWarnings("unused")
  public void setPluginFlag ( final String pluginName, final String flagName, final boolean value ) throws java.rmi.RemoteException
  {
  }

  @SuppressWarnings("unused")
  public void setPluginProperty ( final String pluginName, final String propertyName, final String value ) throws java.rmi.RemoteException
  {
  }
  ...
  @SuppressWarnings("unused")
  public void getInstanceData ( final ObjectMetaData object, final InstanceDataListener listener ) throws java.rmi.RemoteException
  {
    listener.setInstanceCount(0);
  }

  @SuppressWarnings("unused")
  public void getInstanceData ( final ObjectMetaData object, final Object[] pks, final InstanceDataListener listener ) throws java.rmi.RemoteException
  {
    listener.setInstanceCount(0);
  }

  @SuppressWarnings("unused")
  public void getRelatedInstanceData ( final ObjectMetaData object,
                                       final Object pk,
                                       final int relId,
  ...
  @SuppressWarnings("unused")
  public void createInstancePopulation ( final ObjectMetaData object, final InstanceData[] data ) throws java.rmi.RemoteException
  {
  }

  @SuppressWarnings("unused")
  public void createSingleInstance ( final ObjectMetaData object, final InstanceData data ) throws java.rmi.RemoteException
  {
  }

  @SuppressWarnings("unused")
  public void updateSingleInstance ( final ObjectMetaData object, final InstanceData data ) throws java.rmi.RemoteException
  {
  }
  ...
  @SuppressWarnings("unused")
  public void createRelationships ( final RelationshipMetaData rel, final RelationshipData[] data ) throws java.rmi.RemoteException
  {
  }

  @SuppressWarnings("unused")
  public void createSuperSubtypes ( final SuperSubtypeMetaData ss, final SuperSubtypeData[] data ) throws java.rmi.RemoteException
  {
  }
  ...
  @SuppressWarnings("unused")
  public void invokeDomainService ( final DomainServiceMetaData service, final DataValue<?>[] parameters ) throws java.rmi.RemoteException
  {
  }

  @SuppressWarnings("unused")
  public void invokeTerminatorService ( final TerminatorServiceMetaData service, final DataValue<?>[] parameters ) throws java.rmi.RemoteException
  {
  }
  ...
  @SuppressWarnings("unused")
  public void invokeObjectService ( final ObjectServiceMetaData service, final Integer pk, final DataValue<?>[] parameters ) throws java.rmi.RemoteException
  {
  }

  @SuppressWarnings("unused")
  public void fireEvent ( final EventMetaData event, final ObjectMetaData object, final Integer pk, final DataValue<?>[] parameters ) throws java.rmi.RemoteException
  {
  }
