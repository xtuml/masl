...
public class ProcessConnectionGUI
{
  ...
  static private final Action getPluginFlagAction ( final String pluginName, final Plugin.Flag flag, final JMenuItem item )
  {
  ...
  static private final Action getPluginPropertyAction ( final String pluginName,
  ...
  static public void addPluginPropertyMenuItem ( final JMenu parent, final String pluginName, final Plugin.Property property )
  {
  ...
  static private final Action continueAction = new AbstractAction(null,
                                                                  new ImageIcon(ClassLoader
                                                                                           .getSystemResource("icons/play.gif")))
                                             {
  ...
  static private final Action pauseAction    = new AbstractAction(null,
                                                                  new ImageIcon(ClassLoader
                                                                                           .getSystemResource("icons/pause.gif")))
                                             {
  ...
  static private final Action stepAction     = new AbstractAction(null,
                                                                  new ImageIcon(ClassLoader
                                                                                           .getSystemResource("icons/step.gif")))
                                             {
  ...
  static private final Action slomoAction    = new AbstractAction(null,
                                                                  new ImageIcon(ClassLoader
                                                                                           .getSystemResource("icons/slomo.gif")))
                                             {
  ...
  static public JComponent getStepComponent ()
  {
    ...
    button.registerKeyboardAction(stepAction,
                                  KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S, Event.CTRL_MASK),
                                  JComponent.WHEN_IN_FOCUSED_WINDOW);
