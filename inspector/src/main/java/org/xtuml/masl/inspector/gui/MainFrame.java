    ...
    public MainFrame() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                if (chooser.showOpenDialog(MainFrame.this) == JFileChooser.APPROVE_OPTION) {
                    ...
                    try {
                        ...
                        JOptionPane
                                .showMessageDialog(
                                        MainFrame.this, "Parse error in " + spe.getSystemId() + " line "
                                                + spe.getLineNumber() + "\n" + spe.getMessage(),
        ...
        final JMenuItem exportDomainItem = new JMenuItem(new AbstractAction("Export " + curDomain + " Data") {
            ...
            public void actionPerformed(final ActionEvent e) {
                final String fileName = procMeta.getName() + "_"
                        + ((DomainMetaData) domainPicker.getSelectedItem()).getName() + ".xml";
        ...
        final JMenuItem createDomainSchemaItem = new JMenuItem(new AbstractAction("Create " + curDomain + " Schema") {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                new DomainSchema(domainMeta, true, false)
                        .writeToFile(new File(domainMeta.getName() + "_ref_integ.xsd"));
                new DomainSchema(domainMeta, false, true)
                        .writeToFile(new File(domainMeta.getName() + "_unique_id.xsd"));
            }
        });
