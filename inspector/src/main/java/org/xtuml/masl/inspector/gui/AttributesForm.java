...
public class AttributesForm extends Form {
    ...
    public static class StructureEditor implements FormValueEditor {
    ...
    public static class TimerEditor implements FormValueEditor {
    ...
    public static class EventEditor implements FormValueEditor {
    ...
    public static class InstanceEditor implements FormValueEditor {
