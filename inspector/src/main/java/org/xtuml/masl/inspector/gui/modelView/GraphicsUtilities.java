...
class GraphicsUtilities
{
  ...
  public static void drawStringRight ( final Graphics g, final FontMetrics m, final String str, final int x, final int y )
  {
    g.drawString(str, x - m.stringWidth(str), y);
  }

  public static void drawStringCentre ( final Graphics g,
                                        final FontMetrics m,
                                        final String str,
                                        final int x1,
                                        final int x2,
