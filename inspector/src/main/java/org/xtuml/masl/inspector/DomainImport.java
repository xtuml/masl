...
public class DomainImport
{
  ...
  public DomainImport ( final File file, final DomainMetaData domainMeta ) throws SAXParseException
  {
    try
    {
      ...
      final Schema schema = schemaFactory.newSchema(new DOMSource(new DomainSchema(domainMeta, false, false).getDocument()));
  ...
  public static void main ( final String[] args ) throws Exception
  {
    ...
    catch ( final SAXParseException spe )
    {
      ...
      System.out.println("\n** Parsing error in " + args[1] + ", line " + spe.getLineNumber() + ", uri " + spe.getSystemId());
