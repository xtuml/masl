...
public class CommunicationChannel {
    ...
    public char readChar() throws IOException {
        ...
        return new String(new byte[] { ch }, Charset.forName("ISO-8859-1")).charAt(0);
    }
    ...
    public <Type extends ReadableObject> Type[] readObjectArray(final Class<Type[]> type, final Class<Type> contained)
            throws IOException {
        final int length = readInt();
