...
public class SocketForwarder extends Thread {
    ...
    public static void main(final String[] args) {
        ...
        final SocketForwarder mainRedirector = new SocketForwarder(host, port + MAIN_PORT_OFFSET,
                listenPort + MAIN_PORT_OFFSET);
        final SocketForwarder infoRedirector = new SocketForwarder(host, port + INFO_PORT_OFFSET,
                listenPort + INFO_PORT_OFFSET);
        final SocketForwarder consoleRedirector = new SocketForwarder(host, port + CONSOLE_PORT_OFFSET,
