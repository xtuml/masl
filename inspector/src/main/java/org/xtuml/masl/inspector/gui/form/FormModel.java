...
public interface FormModel
{
   ...
   * initialize the form's field header name. Note: this name does not need to
   * be unique; two fields in a form can have the same name.
   * 
   * @param fieldIndex
   ...
   * This is used by the <code>Form</code> to set up a default renderer and
   ...
   * @param fieldIndex
   *          the field whose value to be queried
   ...
   *          the new value
   * @param fieldIndex
   *          the field whose value is to be changed
   * @see #getValueAt
   * @see #isCellEditable
   */
