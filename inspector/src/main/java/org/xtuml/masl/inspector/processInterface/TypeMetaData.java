...
public abstract class TypeMetaData {
    ...
    public enum BasicType {
        AnyInstance, Boolean, Byte, Character, Device, Duration, Enumeration, Event, Instance, Integer, LongInteger,
        LongNatural, Natural, Real, State, String, Structure, Timestamp, WCharacter, WString, Timer, Dictionary;
    }
