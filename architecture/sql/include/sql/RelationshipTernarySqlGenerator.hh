...
class RelationshipTernarySqlGenerator : public RelationshipSql {
  ...
  public:
    ...
    class CachedTernaryContainerSet {
      public:
        CachedTernaryContainerSet(LhsLinkType &lhsLinks, RhsLinkType &rhsLinks,
      ...
      private:
        ...
        CachedTernaryContainerSet &
        operator=(const CachedTernaryContainerSet &rhs);
  ...
  public:
    ...
    virtual void
    loadAll(CachedTernaryContainerSet &cachedTernaryContainers) const = 0;
    virtual void
    loadLhs(const ::SWA::IdType &rhsIdentity,
            CachedTernaryContainerSet &cachedTernaryContainers) const = 0;
    virtual void
    loadRhs(const ::SWA::IdType &lhsIdentity,
            CachedTernaryContainerSet &cachedTernaryContainers) const = 0;
    virtual void
    loadAss(const ::SWA::IdType &Assidentity,
            CachedTernaryContainerSet &cachedTernaryContainers) const = 0;

  private:
    RelationshipTernarySqlGenerator(const RelationshipTernarySqlGenerator &rhs);
    RelationshipTernarySqlGenerator &
    operator=(const RelationshipTernarySqlGenerator &rhs);
};
