...
// !
// ********************************************************************
template <class T> struct PsObject_Traits {
    typedef T PsObject;
...
// ***********************************************************************
// ***********************************************************************
template <class T> class TableStatementGenerator {
  public:
    typedef std::function<void(const T &, const typename T::p_object_ptr &,
                                 std::string &)>
        MethodType;

  public:
    TableStatementGenerator(const T &table, MethodType method,
...
// ***********************************************************************
template <class T>
TableStatementGenerator<T>
StatementGenerator(const T &table,
                   typename TableStatementGenerator<T>::MethodType method,
                   std::string &statements) {
...
// ***********************************************************************
// ***********************************************************************
template <class C> class MatchObjectIdentity {
  public:
...
// ***********************************************************************
// ***********************************************************************
template <class T, class K> class ArchitectureKeyMatch {
  public:
...
// ***********************************************************************
// ***********************************************************************
template <class O, class A> class OneAttributeSelector {
  public:
...
// ***********************************************************************
// ***********************************************************************
template <class O, class A, class B> class TwoAttributeSelector {
  public:
  ...
  public:
    TwoAttributeSelector(GetMethodOneType getMethodOne,
                         ...
                         const A &attributeOneValue, const B &attributeTwoValue)
        : getMethodOne_(getMethodOne), getMethodTwo_(getMethodTwo),
...
//******************************************************************************
//******************************************************************************
inline void checkStream(const std::ostringstream &str,
...
// ********************************************************************
// ********************************************************************
template <class T> std::string convertToColumnValue(T value) {
...
//******************************************************************************
//******************************************************************************
template <class T> inline std::string valueToString(const T value) {
    return std::format("{}",value);
}
...
template <> inline std::string valueToString<const char *>(const char *value) {
    return value;
}
template <> inline std::string valueToString<char *>(char *value) {
    return value;
}

//******************************************************************************
//******************************************************************************
template <class T> T stringToValue(const std::string &iText) {
    return ::boost::lexical_cast<T>(iText);
}

//******************************************************************************
//******************************************************************************
template <class T> T stringToValue(const unsigned char *const iText) {
    return stringToValue<T>(
        std::string(reinterpret_cast<const char *const>(iText)));
}

//******************************************************************************
//******************************************************************************
template <> inline std::string stringToValue(const unsigned char *const iText) {
    return std::string(reinterpret_cast<const char *const>(iText));
}

//******************************************************************************
//******************************************************************************
template <> inline SWA::String stringToValue(const unsigned char *const iText) {
    return SWA::String(reinterpret_cast<const char *const>(iText));
}

//******************************************************************************
//******************************************************************************
template <> inline int64_t stringToValue<int64_t>(const std::string &text) {
    return atoll(text.c_str());
}

//******************************************************************************
//******************************************************************************
template <> inline int stringToValue<int>(const std::string &text) {
