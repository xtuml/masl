...
//! specifications.
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer,
          class AssRelContainer, bool OneC, bool ManyC>
class RelationshipTernaryMapper : public ResourceMonitorObserver {
  public:
    ...
    typedef RelationshipTernarySqlGenerator<LhsRelContainer, RhsRelContainer,
                                           AssRelContainer>
        RelSqlGeneratorType;
    typedef RelationshipTernaryMapperUnitOfWork<RelationshipTernaryMapper>
        UnitOfWorkType;
  ...
  public:
    ...
    void linkFromLhsToRhs(const LhsPsObjectPtr &lhsObj,
                          const RhsPsObjectPtr &rhsObj,
                          const AssPsObjectPtr &assObj);
    void linkFromRhsToLhs(const RhsPsObjectPtr &rhsObj,
                          const LhsPsObjectPtr &lhsObj,
                          const AssPsObjectPtr &assObj);

    void unlinkFromLhsToRhs(const LhsPsObjectPtr &lhsObj,
                            const RhsPsObjectPtr &rhsObj,
                            const AssPsObjectPtr &assObj);
    void unlinkFromRhsToLhs(const RhsPsObjectPtr &rhsObj,
                            const LhsPsObjectPtr &lhsObj,
                            const AssPsObjectPtr &assObj);

    NavigatedAssType correlateFromLhsToRhs(const LhsPsObjectPtr &lhsObj,
                                           const RhsPsObjectPtr &rhsObj);
    NavigatedAssType correlateFromRhsToLhs(const RhsPsObjectPtr &rhsObj,
                                           const LhsPsObjectPtr &lhsObj);
    ...
    void
    commitUnlinks(const typename UnitOfWorkType::UnLinkHashSetType &objects);
  ...
  private:
    ...
    template <class Tuple> void reportError(const Tuple &parameters);
  ...
  private:
    ...
    NavigatedAssType correlate(const NavigatedAssType &lhsAssObjId,
                               const NavigatedAssType &rhsAssObjId);
    NavigatedAssType correlate(const NavigatedAssType &lhsAssObjId,
                               const NavigatedSetType &rhsAssObjIdSet);
    NavigatedAssType correlate(const NavigatedSetType &lhsAssObjIdSet,
                               const NavigatedAssType &rhsAssObjId);
    NavigatedAssType correlate(const NavigatedSetType &lhsAssObjIdSet,
                               const NavigatedSetType &rhsAssObjIdSet);
  ...
  private:
    ...
    typename RelSqlGeneratorType::CachedTernaryContainerSet
        cachedContainerHandle;
};
...
template <int rel, class LhsRelContainer, class RhsRelContainer,
          class AssRelContainer, bool OneC, bool ManyC>
RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer, AssRelContainer,
                         OneC, ManyC>::RelationshipTernaryMapper()
    : allLoaded(false), loadOnDemand(false), writeOnChange(false),
      unitOfWork(*this), cachedContainerHandle(lhsLinks, rhsLinks, assLinks) {}
...
template <int rel, class LhsRelContainer, class RhsRelContainer,
          class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::displayAllLinks(const std::string &location) {
...
template <int rel, class LhsRelContainer, class RhsRelContainer,
          class AssRelContainer, bool OneC, bool ManyC>
template <class T>
void RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                              AssRelContainer, OneC,
                              ManyC>::displayContainer(const std::string &label,
                                                       T &container) {
...
template <int rel, class LhsRelContainer, class RhsRelContainer,
          class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                              AssRelContainer, OneC, ManyC>::
    initialise(const ::std::shared_ptr<RelSqlGeneratorType> &generator) {
    relSqlGenerator = generator;
    unitOfWork.initialise();
    relSqlGenerator->initialise();
    RelationshipSqlRepository::getInstance().registerRelationshipSql(
        relSqlGenerator.get());

    writeOnChange =
        WriteOnChangeEnabler(relSqlGenerator->getTableName()).isEnabled();
...
template <int rel, class LhsRelContainer, class RhsRelContainer,
          class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                              AssRelContainer, OneC, ManyC>::forceFlush() {
    unitOfWork.flush();
}
...
template <int rel, class LhsRelContainer, class RhsRelContainer,
          class AssRelContainer, bool OneC, bool ManyC>
bool RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                              AssRelContainer, OneC, ManyC>::isInitialised()
    const {
...
void RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                              AssRelContainer, OneC,
                              ManyC>::setToLoadOnDemand(bool isEnabled) {
...
void RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::linkFromLhsToRhs(const LhsPsObjectPtr &lhsObj,
                             const RhsPsObjectPtr &rhsObj,
                             const AssPsObjectPtr &assObj) {
    ...
    RelationshipAtomicity<LhsLinksType, RhsPsObjectPtr, AssPsObjectPtr,
                          LinkPolicy>
        atomicLhsLinks(lhsLinks, lhsObjId, rhsObj, assObj);
    RelationshipAtomicity<RhsLinksType, LhsPsObjectPtr, AssPsObjectPtr,
                          LinkPolicy>
        atomicRhsLinks(rhsLinks, rhsObjId, lhsObj, assObj);
    RelationshipAtomicity<AssLinksType, LhsPsObjectPtr, RhsPsObjectPtr,
                          LinkPolicy>
        atomicAssLinks(assLinks, assObjId, lhsObj, rhsObj);
...
void RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::linkFromRhsToLhs(const RhsPsObjectPtr &rhsObj,
                             const LhsPsObjectPtr &lhsObj,
                             const AssPsObjectPtr &assObj) {
...
void RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::unlinkFromLhsToRhs(const LhsPsObjectPtr &lhsObj,
                               const RhsPsObjectPtr &rhsObj,
                               const AssPsObjectPtr &assObj) {
    const ::SWA::IdType &lhsObjId = lhsObj.getChecked()->getArchitectureId();
    const ::SWA::IdType &rhsObjId = rhsObj.getChecked()->getArchitectureId();
    ...
    RelationshipAtomicity<LhsLinksType, RhsPsObjectPtr, AssPsObjectPtr,
                          UnlinkPolicy>
        atomicLhsUnlinks(lhsLinks, lhsObjId, rhsObj, assObj);
    RelationshipAtomicity<RhsLinksType, LhsPsObjectPtr, AssPsObjectPtr,
                          UnlinkPolicy>
        atomicRhsUnlinks(rhsLinks, rhsObjId, lhsObj, assObj);
    RelationshipAtomicity<AssLinksType, LhsPsObjectPtr, RhsPsObjectPtr,
                          UnlinkPolicy>
        atomicAssUnlinks(assLinks, assObjId, lhsObj, rhsObj);
...
void RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::unlinkFromRhsToLhs(const RhsPsObjectPtr &rhsObj,
                               const LhsPsObjectPtr &lhsObj,
                               const AssPsObjectPtr &assObj) {
...
template <int rel, class LhsRelContainer, class RhsRelContainer,
          class AssRelContainer, bool OneC, bool ManyC>
typename RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                                  AssRelContainer, OneC,
                                  ManyC>::NavigatedAssType
RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::correlateFromLhsToRhs(const LhsPsObjectPtr &lhsObj,
                                  const RhsPsObjectPtr &rhsObj) {
    // Check that the required link data is loaded before
    // undertaking any kind of processing on the cache.
...
RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::correlateFromRhsToLhs(const RhsPsObjectPtr &rhsObj,
                                  const LhsPsObjectPtr &lhsObj) {
...
::std::size_t
RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer, AssRelContainer,
                         OneC, ManyC>::countFromLhsToRhs(const LhsPsObjectPtr
                                                             &lhsObj) {
    loadLhsToRhsLinks(lhsObj.getChecked()->getArchitectureId());
    typename LhsLinksType::iterator rhsLinksItr =
        lhsLinks.find(lhsObj.getChecked()->getArchitectureId());
...
::std::size_t
RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer, AssRelContainer,
                         OneC, ManyC>::countFromLhsToAss(const LhsPsObjectPtr
                                                             &lhsObj) {
    loadLhsToRhsLinks(lhsObj.getChecked()->getArchitectureId());
    typename LhsLinksType::iterator assLinksItr =
        lhsLinks.find(lhsObj.getChecked()->getArchitectureId());
...
::std::size_t
RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer, AssRelContainer,
                         OneC, ManyC>::countFromRhsToLhs(const RhsPsObjectPtr
                                                             &rhsObj) {
    loadRhsToLhsLinks(rhsObj.getChecked()->getArchitectureId());
    typename RhsLinksType::iterator rhsLinksItr =
        rhsLinks.find(rhsObj.getChecked()->getArchitectureId());
...
::std::size_t
RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer, AssRelContainer,
                         OneC, ManyC>::countFromRhsToAss(const RhsPsObjectPtr
                                                             &rhsObj) {
    loadRhsToLhsLinks(rhsObj.getChecked()->getArchitectureId());
    typename RhsLinksType::iterator rhsLinksItr =
        rhsLinks.find(rhsObj.getChecked()->getArchitectureId());
...
::std::size_t
RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer, AssRelContainer,
                         OneC, ManyC>::countFromAssToLhs(const AssPsObjectPtr
                                                             &assObj) {
    loadAssociativeLinks(assObj.getChecked()->getArchitectureId());
    typename AssLinksType::iterator assLinksItr =
        assLinks.find(assObj.getChecked()->getArchitectureId());
...
::std::size_t
RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer, AssRelContainer,
                         OneC, ManyC>::countFromAssToRhs(const AssPsObjectPtr
                                                             &assObj) {
    loadAssociativeLinks(assObj.getChecked()->getArchitectureId());
    typename AssLinksType::iterator assLinksItr =
        assLinks.find(assObj.getChecked()->getArchitectureId());
...
template <int rel, class LhsRelContainer, class RhsRelContainer,
          class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                              AssRelContainer, OneC, ManyC>::abortLinks() {
...
void RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                              AssRelContainer, OneC, ManyC>::
    commitLinks(const typename UnitOfWorkType::LinkHashSetType &objects) {
    std::for_each(objects.begin(), objects.end(),
                  [&](const auto &obj) { relSqlGenerator->commitLink(obj); });
}
...
void RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
    ...
    commitUnlinks(const typename UnitOfWorkType::UnLinkHashSetType &objects) {
    std::for_each(objects.begin(), objects.end(),
                  [&](const auto &obj) { relSqlGenerator->commitUnlink(obj); });
}
...
void RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::objectDeletedLhs(const LhsPsObjectPtr &lhsObj) {
    const ::SWA::IdType architectureId =
        lhsObj.getChecked()->getArchitectureId();
...
void RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::objectDeletedRhs(const RhsPsObjectPtr &rhsObj) {
    const ::SWA::IdType architectureId =
        rhsObj.getChecked()->getArchitectureId();
...
void RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::objectDeletedAss(const AssPsObjectPtr &assObj) {
    const ::SWA::IdType architectureId =
        assObj.getChecked()->getArchitectureId();
...
template <int rel, class LhsRelContainer, class RhsRelContainer,
          class AssRelContainer, bool OneC, bool ManyC>
bool RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::hasLinksLhs(const LhsPsObjectPtr &lhsObj) {
    const ::SWA::IdType architectureId =
        lhsObj.getChecked()->getArchitectureId();
    ...
    bool hasLinks =
        lhsLinksItr != lhsLinks.end() && lhsLinksItr->second.isLinked();
    return hasLinks;
}
...
bool RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::hasLinksRhs(const RhsPsObjectPtr &rhsObj) {
    const ::SWA::IdType architectureId =
        rhsObj.getChecked()->getArchitectureId();
    ...
    bool hasLinks =
        rhsLinksItr != rhsLinks.end() && rhsLinksItr->second.isLinked();
    return hasLinks;
}
...
bool RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::hasLinksAss(const AssPsObjectPtr &assObj) {
    const ::SWA::IdType architectureId =
        assObj.getChecked()->getArchitectureId();
    ...
    bool hasLinks =
        assLinksItr != assLinks.end() && assLinksItr->second.isLinked();
    return hasLinks;
}
...
template <int rel, class LhsRelContainer, class RhsRelContainer,
          class AssRelContainer, bool OneC, bool ManyC>
const typename RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                                        AssRelContainer, OneC,
                                        ManyC>::NavigatedRhsType
RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer, AssRelContainer,
                         OneC, ManyC>::navigateFromLhsToRhs(const LhsPsObjectPtr
                                                                &lhsObj) {
    const ::SWA::IdType architectureId =
        lhsObj.getChecked()->getArchitectureId();
...
typename RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                                  AssRelContainer, OneC,
                                  ManyC>::NavigatedSetType
RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::navigateFromLhsToRhs(const LhsPsObjectPtrSet &lhsObjSet) {
    ...
    for (; objItr != endItr; ++objItr) {
        ...
        typename LhsLinksType::iterator lhsLinkItr =
            lhsLinks.find(lhsObjPtr.getChecked()->getArchitectureId());
...
const typename RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                                        AssRelContainer, OneC,
                                        ManyC>::NavigatedLhsType
RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer, AssRelContainer,
                         OneC, ManyC>::navigateFromRhsToLhs(const RhsPsObjectPtr
                                                                &rhsObj) {
    const ::SWA::IdType architectureId =
        rhsObj.getChecked()->getArchitectureId();
...
RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::navigateFromRhsToLhs(const RhsPsObjectPtrSet &rhsObjSet) {
    NavigatedSetType objectSet;
    ...
    for (; objItr != endItr; ++objItr) {
        ...
        typename RhsLinksType::iterator rhsLinkItr =
            rhsLinks.find(rhsObjPtr.getChecked()->getArchitectureId());
...
const typename RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                                        ...
                                        ManyC>::NavigatedAssType
RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer, AssRelContainer,
                         OneC, ManyC>::navigateFromAssToRhs(const AssPsObjectPtr
                                                                &assObj) {
    const ::SWA::IdType architectureId =
        assObj.getChecked()->getArchitectureId();
...
RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::navigateFromAssToRhs(const AssPsObjectPtrSet &assObjSet) {
    NavigatedSetType objectSet;
    ...
    for (; objItr != endItr; ++objItr) {
        ...
        typename AssLinksType::iterator assLinkItr =
            assLinks.find(assObjPtr.getChecked()->getArchitectureId());
...
const typename RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                                        ...
                                        ManyC>::NavigatedAssType
RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer, AssRelContainer,
                         OneC, ManyC>::navigateFromAssToLhs(const AssPsObjectPtr
                                                                &assObj) {
    const ::SWA::IdType architectureId =
        assObj.getChecked()->getArchitectureId();
...
RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::navigateFromAssToLhs(const AssPsObjectPtrSet &assObjSet) {
    NavigatedSetType objectSet;
    typename AssPsObjectPtrSet::const_iterator objItr = assObjSet.begin();
    typename AssPsObjectPtrSet::const_iterator endItr = assObjSet.end();
    for (; objItr != endItr; ++objItr) {
...
const typename RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                                        ...
                                        ManyC>::NavigatedLhsType
RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer, AssRelContainer,
                         OneC, ManyC>::navigateFromRhsToAss(const RhsPsObjectPtr
                                                                &rhsObj) {
    const ::SWA::IdType architectureId =
        rhsObj.getChecked()->getArchitectureId();
...
RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::navigateFromRhsToAss(const RhsPsObjectPtrSet &rhsObjSet) {
    NavigatedSetType objectSet;
    typename RhsPsObjectPtrSet::const_iterator objItr = rhsObjSet.begin();
    typename RhsPsObjectPtrSet::const_iterator endItr = rhsObjSet.end();
    for (; objItr != endItr; ++objItr) {
...
const typename RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                                        ...
                                        ManyC>::NavigatedRhsType
RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer, AssRelContainer,
                         OneC, ManyC>::navigateFromLhsToAss(const LhsPsObjectPtr
                                                                &lhsObj) {
    const ::SWA::IdType architectureId =
        lhsObj.getChecked()->getArchitectureId();
...
RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::navigateFromLhsToAss(const LhsPsObjectPtrSet &lhsObjSet) {
    NavigatedSetType objectSet;
    typename LhsPsObjectPtrSet::const_iterator objItr = lhsObjSet.begin();
    typename LhsPsObjectPtrSet::const_iterator endItr = lhsObjSet.end();
    for (; objItr != endItr; ++objItr) {
...
void RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                              AssRelContainer, OneC,
                              ManyC>::report(ResourceMonitorContext &context) {}
...
void RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                              AssRelContainer, OneC,
                              ManyC>::compact(ResourceMonitorContext &context) {
...
void RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                              AssRelContainer, OneC,
                              ManyC>::release(ResourceMonitorContext &context) {
...
template <int rel, class LhsRelContainer, class RhsRelContainer,
          class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                              AssRelContainer, OneC, ManyC>::loadAll() {
...
template <int rel, class LhsRelContainer, class RhsRelContainer,
          class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                              AssRelContainer, OneC, ManyC>::clearAll() {
    allLoaded = false;
    lhsLinks.clear();
    rhsLinks.clear();
    assLinks.clear();
...
void RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::loadLhsToRhsLinks(const ::SWA::IdType &lhsObjId) {
...
void RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::loadRhsToLhsLinks(const ::SWA::IdType &rhsObjectId) {
    if (allLoaded == false) {
...
void RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::loadAssociativeLinks(const ::SWA::IdType &assObjId) {
    if (allLoaded == false) {
...
RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::correlate(const NavigatedAssType &lhsAssObjId,
                      const NavigatedAssType &rhsAssObjId) {
...
RelationshipTernaryMapper<
    ...
    ManyC>::correlate(const NavigatedAssType &lhsAssObjId,
                      const NavigatedSetType &rhsAssObjIdSet) {
    return rhsAssObjIdSet.find(lhsAssObjId) != rhsAssObjIdSet.end()
               ? lhsAssObjId
               : 0;
}
...
RelationshipTernaryMapper<
    rel, LhsRelContainer, RhsRelContainer, AssRelContainer, OneC,
    ManyC>::correlate(const NavigatedSetType &lhsAssObjIdSet,
                      const NavigatedAssType &rhsAssObjId) {
    return lhsAssObjIdSet.find(rhsAssObjId) != lhsAssObjIdSet.end()
               ? rhsAssObjId
               : 0;
}
...
RelationshipTernaryMapper<
    ...
    std::set_intersection(lhsAssObjIdSet.begin(), lhsAssObjIdSet.end(),
                          rhsAssObjIdSet.begin(), rhsAssObjIdSet.end(),
...
template <int rel, class LhsRelContainer, class RhsRelContainer,
          class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTernaryMapper<rel, LhsRelContainer, RhsRelContainer,
                              AssRelContainer, OneC, ManyC>::flush() {
