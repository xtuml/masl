...
class AssignerStateMapper {
  public:
    ...
    // ********************************************************************
    void cacheAssignerState(const std::string &objectKey,
    ...
    //! @param currentState textual representation of the current state
    // ********************************************************************
    void setAssignerState(const std::string &objectKey,
                          const int32_t currentState);
    ...
    StateType getAssignerState(const std::string &objectKey) {
        AssignerStateContType::iterator assignerItr =
            assignerStates_.find(objectKey);
