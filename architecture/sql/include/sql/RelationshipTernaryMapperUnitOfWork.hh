...
namespace SQL {
    ...
    // ***********************************************************************
    template <class T>
    RelationshipTernaryMapperUnitOfWork<T>::RelationshipTernaryMapperUnitOfWork(T &parent)
    ...
    // ***********************************************************************
    template <class T>
    void RelationshipTernaryMapperUnitOfWork<T>::initialise() {}

    // ***********************************************************************
    // ***********************************************************************
    template <class T>
    void RelationshipTernaryMapperUnitOfWork<T>::linkStatement(const std::string &statement) {
    ...
    // ***********************************************************************
    template <class T>
    void RelationshipTernaryMapperUnitOfWork<T>::unlinkStatement(const std::string &statement) {
        primeParentForChanges();
    ...
    // ***********************************************************************
    template <class T>
    bool RelationshipTernaryMapperUnitOfWork<T>::isDirty() {
    ...
    void RelationshipTernaryMapperUnitOfWork<T>::registerLink(
        const LhsPsObjectPtr &lhsObj, const RhsPsObjectPtr &rhsObj, const AssPsObjectPtr &assoObj
    ) {
        primeParentForChanges();
    ...
    // ***********************************************************************
    template <class T>
    void RelationshipTernaryMapperUnitOfWork<T>::startTransaction(UnitOfWorkContext &context) {
        if (isDirty() == true) {
    ...
    // ***********************************************************************
    template <class T>
    void RelationshipTernaryMapperUnitOfWork<T>::commitTransaction(UnitOfWorkContext &context) {
    ...
    // ***********************************************************************
    template <class T>
    void RelationshipTernaryMapperUnitOfWork<T>::abortTransaction(UnitOfWorkContext &context) {
    ...
    // ***********************************************************************
    template <class T>
    void RelationshipTernaryMapperUnitOfWork<T>::committed(UnitOfWorkContext &context) {
        clear();
    }
    ...
    // ***********************************************************************
    template <class T>
    void RelationshipTernaryMapperUnitOfWork<T>::flush() {
    ...
    // ***********************************************************************
    template <class T>
    void RelationshipTernaryMapperUnitOfWork<T>::clear() {
        linkSet.clear();
        unlinkSet.clear();
