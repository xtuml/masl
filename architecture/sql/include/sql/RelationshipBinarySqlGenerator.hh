...
class RelationshipBinarySqlGenerator : public RelationshipSql {
  ...
  public:
    ...
    virtual void loadAll(LhsToRhsContainerType &lhsToRhsLinkSet,
                         RhsToLhsContainerType &rhsToLhsLinkSet) const = 0;
    virtual void loadLhs(const ::SWA::IdType &rhsIdentity,
                         LhsToRhsContainerType &lhsToRhsLinkSet,
                         RhsToLhsContainerType &rhsToLhsLinkSet) const = 0;
    virtual void loadRhs(const ::SWA::IdType &lhsIdentity,
                         LhsToRhsContainerType &lhsToRhsLinkSet,
                         RhsToLhsContainerType &rhsToLhsLinkSet) const = 0;
  ...
  private:
    ...
    RelationshipBinarySqlGenerator &
    operator=(const RelationshipBinarySqlGenerator &rhs);
};
