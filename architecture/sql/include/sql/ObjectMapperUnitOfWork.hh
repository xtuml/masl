...
//!
// *****************************************************************
template <class T> class ObjectMapperUnitOfWork : public UnitOfWorkObserver {
  public:
    typedef typename PsObject_Traits<typename T::PsObject>::PsObject PsObject;
    typedef
        typename PsObject_Traits<typename T::PsObject>::PsObjectPtr PsObjectPtr;
    typedef typename PsObject_Traits<typename T::PsObject>::PsObjectIdSet
        PsObjectIdSet;
    typedef typename PsObject_Traits<typename T::PsObject>::PsObjectPtrSet
        PsObjectPtrSet;
...
// ***********************************************************************
// ***********************************************************************
template <class T> ObjectMapperUnitOfWork<T>::~ObjectMapperUnitOfWork() {
    clear();
}

// ***********************************************************************
// ***********************************************************************
template <class T> void ObjectMapperUnitOfWork<T>::initialise() {}
...
// ***********************************************************************
// ***********************************************************************
template <class T> void ObjectMapperUnitOfWork<T>::flush() {
...
// ***********************************************************************
// ***********************************************************************
template <class T> void ObjectMapperUnitOfWork<T>::primeParentForChanges() {
...
void ObjectMapperUnitOfWork<T>::flush(UnitOfWorkContext &context) {
    ...
    std::for_each(insertSet.begin(), insertSet.end(),
                  [](auto &&objptr) { objptr.get()->markAsClean(); });
    std::for_each(updateSet.begin(), updateSet.end(),
                  [](auto &&objptr) { objptr.get()->markAsClean(); });
    clear();
}
...
// ***********************************************************************
// ***********************************************************************
template <class T> void ObjectMapperUnitOfWork<T>::clear() {
    insertSet.clear();
    updateSet.clear();
    deleteSet.clear();
