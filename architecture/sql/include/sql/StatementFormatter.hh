...
namespace SQL {
    ...
    class WhereFormatter {
      ...
      public:
        ...
        virtual void addCondition(
            const std::string &columnName, const WhereOperatorType whereOperator, const std::string &columnValue
        ) = 0;
    ...
    class AbstractStatementFactory {
      ...
      public:
        ...
        virtual std::shared_ptr<DropStatementFormatter> createDropStatementFormatter() = 0;
        virtual std::shared_ptr<InsertStatementFormatter> createInsertStatementFormatter() = 0;
        virtual std::shared_ptr<UpdateStatementFormatter> createUpdateStatement() = 0;
        virtual std::shared_ptr<DeleteStatementFormatter> createsDeleteStatement() = 0;
        virtual std::shared_ptr<CreateStatementFormatter> createCreateStatement() = 0;
