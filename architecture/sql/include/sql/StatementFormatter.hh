...
class WhereFormatter {
  ...
  public:
    ...
    virtual void
    addBinaryCondition(const BinaryConditionType binaryCondition) = 0;
...
class InsertStatementFormatter : public StatementFormatter {
  ...
  public:
    ...
    virtual void setColumnValue(const std::string &columnName,
                                const std::string &columnValue) = 0;
...
class UpdateStatementFormatter : public StatementFormatter {
  ...
  public:
    ...
    virtual void setColumnValue(const std::string &columnName,
                                const std::string &columnValue) = 0;
    virtual std::shared_ptr<WhereFormatter> addWhereClause() = 0;
...
class AbstractStatementFactory {
  ...
  public:
    ...
    virtual std::shared_ptr<DropStatementFormatter>
    createDropStatementFormatter() = 0;
    virtual std::shared_ptr<InsertStatementFormatter>
    createInsertStatementFormatter() = 0;
    virtual std::shared_ptr<UpdateStatementFormatter>
    createUpdateStatement() = 0;
    virtual std::shared_ptr<DeleteStatementFormatter>
    createsDeleteStatement() = 0;
    virtual std::shared_ptr<CreateStatementFormatter>
    createCreateStatement() = 0;
