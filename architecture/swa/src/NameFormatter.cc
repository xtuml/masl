...
namespace SWA
{
  ...
  {
    return std::format("{}~>{}",formatTerminatorName(domainId,terminatorId), getInstance().getTerminatorServiceName(domainId,terminatorId,serviceId));
  }

  std::string NameFormatter::formatObjectServiceName ( int domainId, int objectId, int serviceId )
  {
    return std::format("{}.{}",formatObjectName(domainId,objectId),getInstance().getObjectServiceName(domainId,objectId,serviceId));
  }

  std::string NameFormatter::formatStateName ( int domainId, int objectId, int stateId )
  {
    return std::format("{}.{}",formatObjectName(domainId,objectId),getInstance().getStateName(domainId,objectId,stateId));
  }

  std::string NameFormatter::formatEventName ( int domainId, int objectId, int eventId )
  {
    return std::format("{}.{}",formatObjectName(domainId,getInstance().getEventParentObjectId(domainId,objectId,eventId)),getInstance().getEventName(domainId,objectId,eventId));
  }
