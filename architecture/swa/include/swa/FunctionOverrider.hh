...
template <class FunctionType> class FunctionOverrider {
  public:
    ...
    void override(FunctionPtr fn) { overrideFn = fn; }

    void cancelOverride() { overrideFn = 0; }

    bool isOverridden() { return overrideFn != 0; }
