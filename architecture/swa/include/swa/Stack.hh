...
namespace SWA {
    class Stack {
      public:
        ...
        const StackFrame &operator[](int index) const {
            return frames[index];
        }
        StackFrame &operator[](int index) {
            return frames[index];
        }

        const std::vector<StackFrame> &getStackFrames() const {
            return frames;
        }
        ...
        class EnteredCatch {
          public:
            ...
            ~EnteredCatch() {
                ProcessMonitor::getInstance().leavingCatch();
            }
        };
        ...
        class ExecutingStatement {
          public:
            ...
            ~ExecutingStatement() {
                ProcessMonitor::getInstance().endStatement();
            }
        };
