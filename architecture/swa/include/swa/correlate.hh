...
ObjectPtr<AssocObj> correlate_instance(
    const LhsObj *lhs, const ObjectPtr<RhsObj> &rhs,
    ObjectPtr<AssocObj> (LhsObj::*correlator)(const ObjectPtr<RhsObj> &)
        const) {
...
template <class LhsObj, class RhsObj, class AssocObj>
ObjectPtr<AssocObj> correlate_instance(
    const ObjectPtr<LhsObj> &lhs, const ObjectPtr<RhsObj> &rhs,
    ObjectPtr<AssocObj> (LhsObj::*correlator)(const ObjectPtr<RhsObj> &)
        const) {
...
template <class LhsObj, class RhsObj, class AssocObj>
Bag<ObjectPtr<AssocObj>>
correlate_bag(const LhsObj *lhs, const Bag<ObjectPtr<RhsObj>> &rhs,
              Bag<ObjectPtr<AssocObj>> (LhsObj::*correlator)(
                  const Bag<ObjectPtr<RhsObj>> &) const) {
...
correlate_set(const LhsObj *lhs, const Set<ObjectPtr<RhsObj>> &rhs,
              Bag<ObjectPtr<AssocObj>> (LhsObj::*correlator)(
                  const Bag<ObjectPtr<RhsObj>> &) const) {
    if (lhs) {
...
template <class LhsObj, class RhsObj, template <class T> class RhsColl,
          class AssocObj>
Bag<ObjectPtr<AssocObj>>
correlate_bag(const ObjectPtr<LhsObj> &lhs,
...
template <class LhsObj, class RhsObj, class AssocObj>
Set<ObjectPtr<AssocObj>>
correlate_set(const ObjectPtr<LhsObj> &lhs, const Set<ObjectPtr<RhsObj>> &rhs,
              Bag<ObjectPtr<AssocObj>> (LhsObj::*correlator)(
                  const Bag<ObjectPtr<RhsObj>> &) const) {
    if (lhs) {
...
// bag.
template <class LhsObj, template <class T> class LhsColl, class RhsObj,
          template <class T> class RhsColl, class AssocObj>
Bag<ObjectPtr<AssocObj>>
correlate_bag(const LhsColl<ObjectPtr<LhsObj>> &lhs,
              const RhsColl<ObjectPtr<RhsObj>> &rhs,
              Bag<ObjectPtr<AssocObj>> (LhsObj::*correlator)(
                  const Bag<ObjectPtr<RhsObj>> &) const) {
    return combine_collection<Set, ObjectPtr<AssocObj>>(
        lhs,
        [&](const ObjectPtr<LhsObj> &l) { return (l.get().*correlator)(rhs); });
}

// Correlate set with set
template <class LhsObj, class RhsObj, class AssocObj>
Set<ObjectPtr<AssocObj>>
correlate_set(const Set<ObjectPtr<LhsObj>> &lhs,
              const Set<ObjectPtr<RhsObj>> &rhs,
              Bag<ObjectPtr<AssocObj>> (LhsObj::*correlator)(
                  const Bag<ObjectPtr<RhsObj>> &) const) {
    Set<ObjectPtr<AssocObj>> result =
        combine_collection<Set, ObjectPtr<AssocObj>>(
            lhs, [&](const ObjectPtr<LhsObj> &l) {
