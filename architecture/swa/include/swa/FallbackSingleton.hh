...
template <class Singleton, class Fallback> class FallbackSingleton {
  public:
...
bool FallbackSingleton<Singleton, Fallback>::registerSingleton(
...
Singleton &FallbackSingleton<Singleton, Fallback>::getSingleton() {
    static Singleton &singleton =
        getSingletonGetter() ? getSingletonGetter()() : getFallback();
    return singleton;
}
