...
namespace SWA {
    class NamedOption {
      public:
        ...
        const std::string &getParamDescription() const {
            return paramDescription;
        }
        bool hasParameter() const {
            return !paramDescription.empty();
        }
        bool isParamRequired() const {
    ...
    class TrailingOption {
      public:
        TrailingOption(
            const std::string &name, const std::string &usageText, bool required = true, bool multiple = false
        );
    ...
    class CommandLine {
      ...
      public:
        ...
        const std::vector<std::string> &getNameAliases(const std::string &name) {
