  ...
  public:
    class MonitorConnection {
      public:
        ...
        virtual void transitioningState(int domainId, int objectId,
                                        int instanceId, int oldState,
                                        int newState) {}
        virtual void transitioningAssignerState(int domainId, int objectId,
        ...
        virtual void settingTimer(int timerId, const Timestamp &timeout,
        ...
        virtual const std::vector<MonitorConnection *>
    ...
    class ProcessingEventQueue {
      public:
        ProcessingEventQueue() { getInstance().startProcessingEventQueue(); }
    ...
    void settingTimer(int timerId, const Timestamp &timeout,
                      const Duration &period,
                      const std::shared_ptr<Event> &event);
