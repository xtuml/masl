    ...
    class PluginRegistry {
      public:
        ...
        typedef boost::signals2::
            signal_type<void(), boost::signals2::keywords::mutex_type<boost::signals2::dummy_mutex>>::type Signal;
        ...
        virtual void
        registerAction(const std::string &pluginName, const std::string &actionName, const Action &action) = 0;
        ...
        virtual void registerSignalAction(
            const std::string &pluginName, const std::string &signalName, const Action &action
        ) const = 0;
        ...
        virtual void
        registerFlagGetter(const std::string &pluginName, const std::string &flagName, const FlagGetter &getter) = 0;
        virtual void
        registerFlagSetter(const std::string &pluginName, const std::string &flagName, const FlagSetter &setter) = 0;
        ...
        virtual void
        setProperty(const std::string &pluginName, const std::string &propertyName, const std::string &value) const = 0;
