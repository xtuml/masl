...
namespace SQLITE {
    ...
    class ResultSet {
      ...
      public:
        ...
        // *****************************************************************
        const ColumnType getColumns() const {
            return columns_;
        }
        ...
        // *****************************************************************
        const ColumnType lastRow() const {
            return matrix_.size() == 0 ? 0 : matrix_.size() - 1;
        }

        // *****************************************************************
        //! @return The list of column names defined for this result set.
        // *****************************************************************
        const EntryContainerType &getColumnNames() const {
            return columnNames_;
        }
