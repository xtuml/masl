...
namespace SQLITE {
    ...
    class EventParameterCodecs {
      public:
        ...
        typedef std::function<void(std::shared_ptr<SWA::Event>, BlobData &)> Encoder;
        ...
        void encode(const std::shared_ptr<SWA::Event> &event, BlobData &buffer) const;
        std::shared_ptr<SWA::Event> decode(int domainId, int objectId, int eventId, BlobData &buffer) const;
