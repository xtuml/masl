...
class Database : public ::SQL::Database {
  ...
  public:
    ...
    // *****************************************************************
    std::shared_ptr<::SQL::AbstractStatementFactory> getStatementFormatter();
    ...
    // *****************************************************************
    //! Starts a transaction with the specified name. Any registered
    //! unitOfWorkObserver objects will be informed of the start of a
    //! transaction.
    //!
    //! throws SqliteException on error
    // *****************************************************************
    ...
    // *****************************************************************
    void
    validateSchema(const ::SQL::Schema::TableDefinitionType &tableDefinitions);
    ...
    //!
    // *****************************************************************
    static bool finaliseCompile(const char *const location,
                                sqlite3_stmt *ppStmt);
    ...
    //! throws SqliteException on error
    // *****************************************************************
    static void checkCompile(const char *const location,
    ...
    //! throws SqliteException on error
    // *****************************************************************
    static void checkColumnCount(const char *const location,
