...
class PreparedStatement {
  public:
    ...
    // *****************************************************************
    template <class P1> void execute(const P1 &p1) const;
    ...
    void execute(const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4,
                 const P5 &p5) const;
  ...
  private:
    ...
    //! object.
    // *****************************************************************
    template <int32_t index, class T> struct BindTupleElement {
        static void bind(const PreparedStatement &pstatement, int32_t baseIndex,
                         const T &tuple) {
    ...
    // *****************************************************************
    template <class T> struct BindTupleElement<0, T> {
        static void bind(const PreparedStatement &pstatement, int32_t baseIndex,
                         const T &tuple) {
    ...
    // *****************************************************************
    template <class T> struct BindTuple {
        // *****************************************************************
        ...
        static void bind(const PreparedStatement &pstatement, int32_t baseIndex,
            ...
            // order (10,9,8...0).
            BindTupleElement<tuple_length - 1, T>::bind(pstatement, baseIndex,
                                                        tuple);
        }
    };
...
// *****************************************************************
// *****************************************************************
template <class P1> void PreparedStatement::execute(const P1 &p1) const {
    try {
...
// *****************************************************************
template <class P1, class P2, class P3>
void PreparedStatement::execute(const P1 &p1, const P2 &p2,
                                const P3 &p3) const {
    try {
        BindTuple<P3>::bind(*this,
...
// *****************************************************************
template <class P1, class P2, class P3, class P4>
void PreparedStatement::execute(const P1 &p1, const P2 &p2, const P3 &p3,
                                const P4 &p4) const {
    try {
        BindTuple<P4>::bind(*this,
                            ::boost::tuples::length<P1>::value +
                                ::boost::tuples::length<P2>::value +
...
template <class P1, class P2, class P3, class P4, class P5>
void PreparedStatement::execute(const P1 &p1, const P2 &p2, const P3 &p3,
                                const P4 &p4, const P5 &p5) const {
    try {
        BindTuple<P5>::bind(*this,
                            ::boost::tuples::length<P1>::value +
                                ::boost::tuples::length<P2>::value +
                                ::boost::tuples::length<P3>::value +
                                ::boost::tuples::length<P4>::value,
                            p5);
        BindTuple<P4>::bind(*this,
                            ::boost::tuples::length<P1>::value +
                                ::boost::tuples::length<P2>::value +
...
void PreparedStatement::execute(const P1 &p1, const P2 &p2, const P3 &p3,
                                ...
                                const P7 &p7) const {
    try {
        BindTuple<P7>::bind(*this,
                            ::boost::tuples::length<P1>::value +
                                ::boost::tuples::length<P2>::value +
                                ::boost::tuples::length<P3>::value +
                                ::boost::tuples::length<P4>::value +
                                ::boost::tuples::length<P5>::value +
                                ::boost::tuples::length<P6>::value,
                            p7);
        BindTuple<P6>::bind(*this,
                            ::boost::tuples::length<P1>::value +
                                ::boost::tuples::length<P2>::value +
