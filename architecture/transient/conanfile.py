...
class ConanFile(conan.ConanFile):
    ...
    description = "xtUML C++ Software Architecture Transient Instance Populations"
    topics = ("xtuml", "masl", "transient")
    ...
    def package_info(self):
        self.cpp_info.libs = ["xtuml_transient"]
