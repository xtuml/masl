...
namespace transient {
template <class Related, class Associative> class ToOneAssociative {
  private:
...
void ToOneAssociative<Related, Associative>::link(RelatedPtr rhs,
                                                  AssociativePtr associative) {
    if (related)
...
template <class Related, class Associative>
void ToOneAssociative<Related, Associative>::unlink(
    RelatedPtr rhs, AssociativePtr associative) {
    if (related != rhs)
