...
class MethodImpl extends TypeMemberImpl
    implements Method,
    Constructor, ModifiersImpl.Filter, Scoped
{

  private final class MDScope
      extends Scope
  {
  ...
  public MethodImpl copyForOverride ()
  {
    ...
    final Map<TypeParameterImpl, TypeParameterImpl> typeParamMap = new HashMap<TypeParameterImpl, TypeParameterImpl>();
    ...
    {
      if ( param.getType() instanceof TypeVariableImpl )
      {
        final TypeVariableImpl typeVar = (TypeVariableImpl)param.getType();
