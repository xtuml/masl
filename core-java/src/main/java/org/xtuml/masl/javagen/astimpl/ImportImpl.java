...
public class ImportImpl extends ASTNodeImpl
    implements Import
{
  ...
  ImportImpl ( final ASTImpl ast, final TypeDeclaration typeDeclaration,
  ...
  public boolean imports ( final TypeDeclarationImpl typeDeclaration )
  {
    if ( isStatic() )
    {
      ...
      if ( isOnDemand() )
      {
        return typeDeclaration.getDeclaringType() == this.typeDeclaration && typeDeclaration.getName()
                                                                                                              .equals(importedName);
      }
      else
      {
