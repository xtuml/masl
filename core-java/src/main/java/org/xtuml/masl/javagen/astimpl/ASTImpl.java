...
public class ASTImpl extends ASTNodeImpl
    implements AST
{
  ...
  @Override
  public AssignmentImpl createAssignment ( final Expression target,
  ...
  @Override
  public ForImpl createFor ( final LocalVariable variable, final Expression condition, final StatementExpression update )
  {
  ...
  @Override
  public NewArrayImpl createNewArray ( final Type type,
                                                                     final int noDimensions,
  ...
  @Override
  public NewInstanceImpl createNewInstance ( final DeclaredType instanceType,
                                                                           final Expression... args )
  {
  ...
  @Override
  public ParameterImpl createParameter ( final Type type,
                                                               final String name )
  {
  ...
  @Override
  public ImportImpl createSingleStaticImport ( final TypeDeclaration typeDeclaration,
                                                          final String name )
  {
  ...
  public TypeImpl createType ( final java.lang.reflect.Type type )
  {
    if ( type instanceof java.lang.reflect.ParameterizedType )
    {
      ...
      final DeclaredTypeImpl result = createDeclaredType(getTypeDeclaration((java.lang.Class<?>)pt.getRawType()));
    ...
    {
      final java.lang.reflect.WildcardType wct = (java.lang.reflect.WildcardType)type;
    ...
    {
      final java.lang.reflect.TypeVariable<?> tv = (java.lang.reflect.TypeVariable<?>)type;
  ...
  final private Map<java.lang.Package, MirroredPackageImpl> packageLookup       = new HashMap<java.lang.Package, MirroredPackageImpl>();
