//
// File: BinaryMultiplicativeExpression.java
//
...
public class BinaryMultiplicativeExpression extends BinaryExpression
{
  ...
  public BinaryMultiplicativeExpression ( Expression lhs, final OperatorRef operator, Expression rhs ) throws SemanticError
  {
    ...
    if ( RealType.createAnonymous().isAssignableFrom(getLhs()) && RealType.createAnonymous().isAssignableFrom(getRhs()) )
    {
        ...
        switch ( getOperator() )
        {
          ...
          case MOD:
          {
            ...
            return new RealLiteral(rem
                                     + (rem != 0 && (((lhsNum < 0) && (rhsNum > 0)) || ((lhsNum > 0) && (rhsNum < 0))) ? rhsNum : 0));
          }
          default:
        ...
        switch ( getOperator() )
        {
          ...
          case MOD:
          {
            ...
            return new IntegerLiteral(rem
                                        + (rem != 0 && (((lhsNum < 0) && (rhsNum > 0)) || ((lhsNum > 0) && (rhsNum < 0))) ? rhsNum
                                                                                                                         : 0));
          }
          default:
            assert false : "Invalid multiplicative operator " + getOperator();
