...
public final class TypeDeclaration extends Name
implements org.xtuml.masl.metamodel.type.TypeDeclaration
{
                                         ...
                                         final PragmaList pragmas )
  {
    ...
    try
    {
      final TypeDeclaration type = new TypeDeclaration(position, domain, name, visibility, typeDefinition, pragmas);
      domain.addType(type);
      return type;
    }
    catch ( final SemanticError e )
  ...
  public boolean equals ( final Object obj )
  {
    ...
    {
      final TypeDeclaration rhs = (TypeDeclaration)obj;
  ...
  public String toString ()
  {
    return (comment == null ? "" : TextUtils.textBlock("", null, "// ", comment, "", true)) +
        visibility + (visibility.toString().equals("") ? "" : " ") + "type\t" + getName() + "\tis "
        + typeDefinition + ";\n" + pragmas;
  }
