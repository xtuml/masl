...
public class GenerateStatement extends Statement
    implements org.xtuml.masl.metamodel.code.GenerateStatement
{
    ...
    else if ( toInstance != null )
    {
      ...
      switch ( event.getType() )
      {
        case NORMAL:
          ...
          {
            throw new SemanticError(SemanticErrorCode.InvalidEventDestination, toInstance.getPosition(), destObject.getName());
          }
