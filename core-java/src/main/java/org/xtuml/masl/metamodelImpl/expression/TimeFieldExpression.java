...
public class TimeFieldExpression extends Expression
    implements org.xtuml.masl.metamodel.expression.TimeFieldExpression
{
  ...
  TimeFieldExpression ( final Position position, final Expression lhs, final String characteristic ) throws SemanticError
  {
    super(position);
    this.lhs = lhs;
  ...
  private TimeFieldExpression ( final Position position, final Expression lhs, final String characteristic, final Field field )
  {
    super(position);
    this.characteristic = characteristic;
    this.lhs = lhs;
