    ...
    implements org.xtuml.masl.metamodel.expression.DictionaryContainsExpression
{
  ...
  public DictionaryContainsExpression ( final Position position, final Expression prefix, final Expression index ) throws SemanticError
  {
    super(position);
  ...
  public boolean equals ( final Object obj )
  {
    ...
    if ( obj instanceof DictionaryContainsExpression )
    {

      final DictionaryContainsExpression obj2 = ((DictionaryContainsExpression)obj);
  ...
  {
    return v.visitDictionaryContainsExpression(this, p);
  }
