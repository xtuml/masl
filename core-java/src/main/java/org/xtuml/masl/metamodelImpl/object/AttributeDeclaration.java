...
public class AttributeDeclaration extends Name
    implements org.xtuml.masl.metamodel.object.AttributeDeclaration
{
                                              ...
                                              final PragmaList pragmas )
  {
    ...
    try
    {
      final AttributeDeclaration att = new AttributeDeclaration(object,
                                                                name,
                                                                type,
