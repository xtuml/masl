...
public class Std
{
  ...
  {
    return new Function("for_each", std, algorithmInc).asFunctionCall(
                                                                      new Function("begin").asFunctionCall(coll, false),
                                                                      new Function("end").asFunctionCall(coll, false),
                                                                      fn).asStatement();
  }
  ...
  {
    return ostreamExpression(Arrays.<Expression>asList(args));
  }
  ...
  public static final TypedefType int8      = new TypedefType("int8_t", null, new TypeUsage(FundamentalType.SCHAR), stdintInc);
  public static final TypedefType uint8     = new TypedefType("uint8_t", null, new TypeUsage(FundamentalType.UCHAR), stdintInc);

  public static final TypedefType int32     = new TypedefType("int32_t", null, new TypeUsage(FundamentalType.INT), stdintInc);
  public static final TypedefType uint32    = new TypedefType("uint32_t", null, new TypeUsage(FundamentalType.UINT), stdintInc);

  public static final TypedefType int64     = new TypedefType("int64_t", null, new TypeUsage(FundamentalType.LONG), stdintInc);
  public static final TypedefType uint64    = new TypedefType("uint64_t", null, new TypeUsage(FundamentalType.ULONG), stdintInc);
