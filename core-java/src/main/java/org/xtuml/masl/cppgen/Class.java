...
public final class Class extends Type
{
  ...
  private class ClassDeclaration extends Declaration
  {
    ...
    public boolean equals ( final Object rhs )
    {
      ...
      if ( rhs instanceof ClassDeclaration )
      {
        final ClassDeclaration rhsCl = (ClassDeclaration)rhs;
    ...
    void writeDeclaration ( final Writer writer, final String indent, final Namespace currentNamespace ) throws IOException
    {
      ...
      TextUtils.formatList(writer, superclasses, "\n" + indent + TextUtils.getIndent() + ": ", ",\n"
          + indent
          + TextUtils.getIndent()
          + "  ", "");
   ...
   */
  public void addEnumeration ( final DeclarationGroup groupKey, final EnumerationType enumeration, final Visibility visibility )
  {
   ...
   */
  public Function createMemberFunction ( final DeclarationGroup declarationGroup, final String name, final Visibility visibility )
  {
    final Function function = new Function(name);
    function.setMember();
    addDeclaration(declarationGroup, function.getDeclaration(), visibility);
  ...
  public Function createCastFunction ( final DeclarationGroup declarationGroup, final TypeUsage type, final Visibility visibility )
  {
    final Function function = new Function("operator");
    function.setMember();
   ...
   * @return the function that was created
   */
  public Function createStaticFunction ( final DeclarationGroup declarationGroup, final String name, final Visibility visibility )
  {
    final Function function = new Function(name);
    function.setStatic(true);
    addDeclaration(declarationGroup, function.getDeclaration(), visibility);
  ...
  String getQualifiedName ( final Namespace currentNamespace )
  {
    ...
    if ( this.getDeclaration().getParentClass() != null &&
         this.getDeclaration().getParentClass().isTemplateType() )
    {
    ...
    return typenameQualifier + super.getQualifiedName(currentNamespace)
   ...
   * @throws IOException
   */
  void writeChildDeclarations ( final Writer writer, final String indent, final Namespace currentNamespace ) throws IOException
  {
    for ( final DeclarationGroup group : declarationGroups )
    {
   ...
   *          the visibility of the new class
   */
  private void addDeclaration ( final DeclarationGroup declarationGroup, final Declaration declaration, final Visibility visibility )
  {
