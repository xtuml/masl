...
public final class TypeUsage
{
  ...
  final public static Modifiers ConstPointerToConst = new Modifiers(true, new boolean[]
                                                      { true }, false);
  final public static Modifiers ConstReference      = new Modifiers(true, null, true);
  final public static Modifiers Pointer             = new Modifiers(false, new boolean[]
                                                      { false }, false);
  final public static Modifiers PointerToConst      = new Modifiers(false, new boolean[]
                                                      { true }, false);
