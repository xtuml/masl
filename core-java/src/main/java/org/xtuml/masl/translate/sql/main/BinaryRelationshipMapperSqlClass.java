/*
 * Filename : BinaryRelationshipMapperSqlClass.java
 * 
 ...
 */
public class BinaryRelationshipMapperSqlClass
    implements GeneratedRelationshipClass
{
  ...
  protected void addConstructorMethod ()
  {
    ...
    constructor.setInitialValue(pepreparedUnlink, Literal.createStringLiteral(unlinkPreparedStatement.getStatement()));
  ...
  protected void addCommitMethods ()
  {
    ...
    final Variable linkObjectsVar = commitLinkFn.createParameter(new TypeUsage(mapperSqlClass.referenceNestedType("LinkedPairType"),
    ...
    final Expression getLinkFirstArhIdFnCall = getArhIdFn.asFunctionCall(getCheckedFn.asFunctionCall(new Variable("first").asMemberReference(linkObjectsVar.asExpression(),
                                                                                                                                             false),
                                                                                                     false),
                                                                         true);
    final Expression getLinkSecondArhIdFnCall = getArhIdFn.asFunctionCall(getCheckedFn.asFunctionCall(new Variable("second").asMemberReference(linkObjectsVar.asExpression(),
                                                                                                                                               false),
                                                                                                      false),
                                                                          true);
    final Expression LinkExecuteFnCall = executeFn.asFunctionCall(pepreparedLink.asExpression(),
                                                                  false,
                                                                  BigTuple.getTupleList((Arrays.asList(new Expression[]
                                                                    { getLinkFirstArhIdFnCall, getLinkSecondArhIdFnCall }))));
    ...
    final Variable unlinkObjectsVar = commitUnlinkFn.createParameter(new TypeUsage(mapperSqlClass.referenceNestedType("LinkedPairType"),
                                                                                   TypeUsage.ConstReference),
                                                                     "unlinkObjects");
    commitUnlinkFn.setConst(true);
    final Expression getunLinkFirstArhIdFnCall = getArhIdFn.asFunctionCall(getCheckedFn.asFunctionCall(new Variable("first").asMemberReference(unlinkObjectsVar.asExpression(),
                                                                                                                                               false),
                                                                                                       false),
                                                                           true);
    final Expression getunLinkSecondArhIdFnCall = getArhIdFn.asFunctionCall(getCheckedFn.asFunctionCall(new Variable("second").asMemberReference(unlinkObjectsVar.asExpression(),
                                                                                                                                                 false),
                                                                                                        false),
                                                                            true);
    final Expression unLinkExecuteFnCall = executeFn.asFunctionCall(pepreparedUnlink.asExpression(),
                                                                    false,
                                                                    BigTuple.getTupleList((Arrays.asList(new Expression[]
                                                                      { getunLinkFirstArhIdFnCall, getunLinkSecondArhIdFnCall }))));
  ...
  protected void addLoadAll ()
  {
    ...
    final Variable lhsToRhsLinkSet = loadAllFn.createParameter(new TypeUsage(mapperSqlClass.referenceNestedType("LhsToRhsContainerType"),
                                                                             TypeUsage.Reference),
                                                               "lhsToRhsLinkSet");
    final Variable rhsToLhsLinkSet = loadAllFn.createParameter(new TypeUsage(mapperSqlClass.referenceNestedType("RhsToLhsContainerType"),
                                                                             TypeUsage.Reference),
                                                               "rhsToLhsLinkSet");
  ...
  protected void addLoadRhs ()
  {
    ...
    final Variable identityVar = loadRhsFn.createParameter(new TypeUsage(Architecture.ID_TYPE, TypeUsage.ConstReference),
                                                           "lhsIdentity");
    final Variable lhsToRhsLinkSet = loadRhsFn.createParameter(new TypeUsage(mapperSqlClass.referenceNestedType("LhsToRhsContainerType"),
                                                                             TypeUsage.Reference),
                                                               "lhsToRhsLinkSet");
    final Variable rhsToLhsLinkSet = loadRhsFn.createParameter(new TypeUsage(mapperSqlClass.referenceNestedType("RhsToLhsContainerType"),
                                                                             TypeUsage.Reference),
                                                               "rhsToLhsLinkSet");
  ...
  protected void addLoadLhs ()
  {
    ...
    final Variable identityVar = loadLhsFn.createParameter(new TypeUsage(Architecture.ID_TYPE, TypeUsage.ConstReference),
                                                           "rhsIdentity");
    final Variable lhsToRhsLinkSet = loadLhsFn.createParameter(new TypeUsage(mapperSqlClass.referenceNestedType("LhsToRhsContainerType"),
                                                                             TypeUsage.Reference),
                                                               "lhsToRhsLinkSet");
    final Variable rhsToLhsLinkSet = loadLhsFn.createParameter(new TypeUsage(mapperSqlClass.referenceNestedType("RhsToLhsContainerType"),
                                                                             TypeUsage.Reference),
                                                               "rhsToLhsLinkSet");
