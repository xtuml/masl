/*
 * Filename : RelationshipMapperClass.java
 *
...
public class RelationshipMapperClass
{
  ...
  private final Map<String, GeneratedRelationshipClass> superToSubRelMapperSqlList = new HashMap<String, GeneratedRelationshipClass>();
                                   ...
                                   final Namespace parentNamespace )
  {
    ...
    this.namespace = new Namespace(Mangler.mangleName(relationshipTran.getFramework().getMainDomainTranslator().getDomain()),
                                   parentNamespace);
    ...
    headerFile = relationshipTran.getFramework().getLibrary().createPrivateHeader("Sqlite" + Mangler.mangleFile(relationshipDecl) + "Mapper");
    sqlBodyFile = relationshipTran.getFramework().getLibrary().createBodyFile(databaseTraits.getName() + Mangler.mangleFile(relationshipDecl) + "MapperSql");
    sqlHeaderFile = relationshipTran.getFramework().getLibrary().createPrivateHeader(databaseTraits.getName() + Mangler.mangleFile(relationshipDecl) + "MapperSql");
    ...
    switch ( relationshipType )
    {
      ...
      case OneToMany:
      case ManyToOne:
        final NormalRelationshipDeclaration actualRelationship = (NormalRelationshipDeclaration)relationshipDecl;
      ...
      case AssocManyToMany:
        final AssociativeRelationshipDeclaration actualAssocRelationship = (AssociativeRelationshipDeclaration)relationshipDecl;
        generateForAssociativeRelationship(actualAssocRelationship, relationshipType);
        break;

      case SubToSuper:
      case SuperToSub:
        final SubtypeRelationshipDeclaration actualSuperSubRelationship = (SubtypeRelationshipDeclaration)relationshipDecl;
                                               ...
                                               final RelationshipType relationshipType )
  {
    ...
    final ObjectTranslator leftObjectTranslator = relationshipTran.getFramework().getObjectTranslator(leftObjectDeclaration);
    ...
    final ObjectTranslator rightObjectTranslator = relationshipTran.getFramework().getObjectTranslator(rightObjectDeclaration);
    if ( relationshipType == RelationshipType.OneToOne )
    {
      relationshipMapper = Relationship.oneToOneRelationshipMapper(RelationshipTranslator.getRelationshipNumber(relationshipDecl),
      ...
      mapperSqlClass = new BinaryRelationshipMapperSqlClass(this, relationshipMapper.asClass(), actualRelationship, parentNamespace);
    }
    else if ( relationshipType == RelationshipType.OneToMany )
    {
      relationshipMapper = Relationship.oneToManyRelationshipMapper(RelationshipTranslator.getRelationshipNumber(relationshipDecl),
                                                                     leftObjectTranslator.getClass("ImplementationClass"),
                                                                     rightObjectTranslator.getClass("ImplementationClass"),
                                                                     actualRelationship.getLeftConditional(),
                                                                     actualRelationship.getRightConditional(),
    ...
    {
      relationshipMapper = Relationship.ManyToOneRelationshipMapper(RelationshipTranslator.getRelationshipNumber(relationshipDecl),
                                                                    leftObjectTranslator.getClass("ImplementationClass"),
                                                                    rightObjectTranslator.getClass("ImplementationClass"),
                                                                    actualRelationship.getLeftConditional(),
                                                                    actualRelationship.getRightConditional(),
                                                    ...
                                                    final RelationshipType relationshipType )
  {
    ...
    final ObjectTranslator leftAssocObjTranslator = relationshipTran.getFramework().getObjectTranslator(leftAssocObjectDecl);
    final ObjectTranslator rightAssocObjTranslator = relationshipTran.getFramework().getObjectTranslator(rightAssocObjectDecl);
    final ObjectTranslator assocObjTranslator = relationshipTran.getFramework().getObjectTranslator(assocObjectDecl);

    if ( relationshipType == RelationshipType.AssocOneToOne )
    {
      relationshipMapper = Relationship.assocOneToOneRelationshipMapper(RelationshipTranslator.getRelationshipNumber(relationshipDecl),
                                                                        ...
                                                                        namespace);
      headerFile.addTypedefDeclaration(relationshipMapper);
      mapperSqlClass = new TenaryRelationshipMapperSqlClass(this,
    ...
    {
      relationshipMapper = Relationship.assocOneToManyRelationshipMapper(RelationshipTranslator.getRelationshipNumber(relationshipDecl),
                                                                          leftAssocObjTranslator.getClass("ImplementationClass"),
                                                                          rightAssocObjTranslator.getClass("ImplementationClass"),
                                                                          assocObjTranslator.getClass("ImplementationClass"),
                                                                          actualAssocRelationship.getLeftConditional(),
    ...
    {
      relationshipMapper = Relationship.assocManyToOneRelationshipMapper(RelationshipTranslator.getRelationshipNumber(relationshipDecl),
                                                                         leftAssocObjTranslator.getClass("ImplementationClass"),
                                                                         rightAssocObjTranslator.getClass("ImplementationClass"),
                                                                         assocObjTranslator.getClass("ImplementationClass"),
                                                                         actualAssocRelationship.getLeftConditional(),
    ...
    {
      relationshipMapper = Relationship.assocManyToManyRelationshipMapper(RelationshipTranslator.getRelationshipNumber(relationshipDecl),
                                                                          leftAssocObjTranslator.getClass("ImplementationClass"),
                                                                          rightAssocObjTranslator.getClass("ImplementationClass"),
                                                                          assocObjTranslator.getClass("ImplementationClass"),
                                                                          actualAssocRelationship.getLeftConditional(),
                                                   ...
                                                   final RelationshipType relationshipType )
  {
    ...
    final ObjectTranslator superObjTranslator = relationshipTran.getFramework()
                                                                .getObjectTranslator(actualSuperSubRelationship.getSupertype());
    for ( final ObjectDeclaration derivedObjDecl : actualSuperSubRelationship.getSubtypes() )
    {
      final ObjectTranslator derivedObjTranslator = relationshipTran.getFramework().getObjectTranslator(derivedObjDecl);
      final String relClassName = getSuperToSubRelClassName(actualSuperSubRelationship.getName(), superTypeObjDecl, derivedObjDecl);
      final TypedefType relationshipMapper = Relationship.oneToOneRelationshipMapper(RelationshipTranslator.getRelationshipNumber(relationshipDecl),
                                                                                     ...
                                                                                     namespace);
      headerFile.addTypedefDeclaration(relationshipMapper);
      final SubTypeRelationshipMapperSqlClass subtypeMapperSql = new SubTypeRelationshipMapperSqlClass(this,
                                                                                                       relationshipMapper.asClass(),
  ...
  {
    return "Relationship" + relationshipName + "_" + superObjDecl.getName() + "_" + subtypeObjDecl.getName() + "Mapper";
  }
}
