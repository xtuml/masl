...
public class DomainTranslator extends org.xtuml.masl.translate.DomainTranslator
{
  ...
  private DomainTranslator ( final Domain domain )
  {
    ...
    this.library = new SharedLibrary(mainTranslator.getLibrary().getName() + "_inspector").inBuildSet(mainTranslator.getBuildSet()).withCCDefaultExtensions();
    this.interfaceLibrary = new SharedLibrary(mainTranslator.getLibrary().getName() + "_if_inspector").inBuildSet(mainTranslator.getBuildSet()).withCCDefaultExtensions();
  ...
  {
    return Arrays.<org.xtuml.masl.translate.DomainTranslator>asList(mainTranslator);
  }
  ...
  public void translate ()
  {
    ...
    {
      final CodeFile codeFile = type.getVisibility() == org.xtuml.masl.metamodel.common.Visibility.PUBLIC ? typesCodeFile
  ...
  private final Map<DomainService, ActionTranslator>        serviceTranslators    = new HashMap<DomainService, ActionTranslator>();
  ...
  private void addDomainClass ()
  {
    ...
    for ( final ObjectDeclaration object : domain.getObjects() )
    {
      ...
      constructor.getCode()
                 .appendExpression(registerObjectHandler.asFunctionCall(id,
                                                                        objPtrType
                                                                                  .callConstructor(new NewExpression(new TypeUsage(objectHandlerClass)))));
    ...
    for ( final DomainTerminator terminator : domain.getTerminators() )
    {
      ...
      constructor.getCode()
                 .appendExpression(registerTerminatorHandler.asFunctionCall(id,
                                                                            termPtrType
                                                                                       .callConstructor(new NewExpression(new TypeUsage(terminatorHandlerClass)))));
      ...
      if ( servTrans != null )
      {
        ...
        constructor.getCode()
                   .appendExpression(registerServiceHandler.asFunctionCall(id,
                                                                           srvPtrType
                                                                                     .callConstructor(new NewExpression(new TypeUsage(actionHandlerClass)))));
      }
  ...
  {
    final Function relCreator = domainHandlerClass.createMemberFunction(group, "createRelationship", Visibility.PUBLIC);
    codeFile.addFunctionDefinition(relCreator);

    final Expression channel = relCreator.createParameter(new TypeUsage(Inspector.commChannel, TypeUsage.Reference), "channel")
                                         .asExpression();
  ...
  CodeBlock getRelationshipCreator ( final RelationshipDeclaration rel, final Expression channel )
  {
    ...
    if ( rel instanceof NormalRelationshipDeclaration )
    {
      final NormalRelationshipDeclaration nrel = (NormalRelationshipDeclaration)rel;
      ...
      group.appendStatement(new BinaryExpression(new BinaryExpression(channel, BinaryOperator.RIGHT_SHIFT, lhsId.asExpression()),
                                                 BinaryOperator.RIGHT_SHIFT,
                                                 rhsId.asExpression()).asStatement());

      final org.xtuml.masl.translate.main.object.ObjectTranslator lhsTrans = org.xtuml.masl.translate.main.object.ObjectTranslator
                                                                                                                                .getInstance(nrel.getLeftObject());
      final org.xtuml.masl.translate.main.object.ObjectTranslator rhsTrans = org.xtuml.masl.translate.main.object.ObjectTranslator
                                                                                                                                .getInstance(nrel.getRightObject());
      ...
      final Function linker = lhsTrans.getRelationshipTranslator(nrel.getLeftToRightSpec())
                                      .getPublicAccessors()
    ...
    else if ( rel instanceof AssociativeRelationshipDeclaration )
    {
      final AssociativeRelationshipDeclaration arel = (AssociativeRelationshipDeclaration)rel;
      ...
      group.appendStatement(new BinaryExpression(new BinaryExpression(new BinaryExpression(channel,
                                                 ...
                                                 BinaryOperator.RIGHT_SHIFT,
                                                 assocId
                                                        .asExpression()).asStatement());

      final org.xtuml.masl.translate.main.object.ObjectTranslator lhsTrans = org.xtuml.masl.translate.main.object.ObjectTranslator
                                                                                                                                .getInstance(arel.getLeftObject());
      final org.xtuml.masl.translate.main.object.ObjectTranslator rhsTrans = org.xtuml.masl.translate.main.object.ObjectTranslator
                                                                                                                                .getInstance(arel.getRightObject());
      final org.xtuml.masl.translate.main.object.ObjectTranslator assocTrans = org.xtuml.masl.translate.main.object.ObjectTranslator
                                                                                                                                  .getInstance(arel.getAssocObject());
      final Expression lhsObj = lhsTrans.getGetInstance().asFunctionCall(lhsId.asExpression());
      final Expression rhsObj = rhsTrans.getGetInstance().asFunctionCall(rhsId.asExpression());
      final Expression assocObj = assocTrans.getGetInstance().asFunctionCall(assocId.asExpression());

      final Function linker = lhsTrans.getRelationshipTranslator(arel.getLeftToRightSpec())
                                      .getPublicAccessors()
                                      .getSingleLinkFunction();
    ...
    else if ( rel instanceof SubtypeRelationshipDeclaration )
    {
      final SubtypeRelationshipDeclaration srel = (SubtypeRelationshipDeclaration)rel;
      ...
      final org.xtuml.masl.translate.main.object.ObjectTranslator supTrans = org.xtuml.masl.translate.main.object.ObjectTranslator
                                                                                                                                .getInstance(srel.getSupertype());
      final Variable supObj = new Variable(supTrans.getPointerType(), "supObj", supTrans.getGetInstance()
                                                                                        .asFunctionCall(supId
                                                                                                             .asExpression()));
      ...
      for ( final ObjectDeclaration subObjDecl : srel.getSubtypes() )
      {
        ...
        final org.xtuml.masl.translate.main.object.ObjectTranslator subTrans = org.xtuml.masl.translate.main.object.ObjectTranslator
                                                                                                                                  .getInstance(subObjDecl);

        final Expression subObj = subTrans.getGetInstance().asFunctionCall(subId.asExpression());

        final Function linker = supTrans.getRelationshipTranslator(srel.getSuperToSubSpec(subObjDecl))
                                        .getPublicAccessors()
                                        .getSingleLinkFunction();
  ...
  private void addRegistration ()
  {
    ...
    final Expression registerDomain = registerDomainFunc.asFunctionCall(processHandler,
                                                                        false,
                                                                        getId,
                                                                        ptrType
                                                                               .callConstructor(new NewExpression(new TypeUsage(domainHandlerClass))));

    final Variable registered = new Variable(new TypeUsage(FundamentalType.BOOL),
  ...
  private Function addStructureWriter ( final StructureType struct )
  {
    ...
    final Function write = Inspector.bufferedOutputStream.specialiseMemberFunction("write",
                                                                                   TemplateSpecialisation
                                                                                                         .create(new TypeUsage(mainClass)));
  ...
  private Function addStructureReader ( final StructureType struct )
  {
    ...
    final Function read = Inspector.bufferedInputStream.specialiseMemberFunction("read",
                                                                                 TemplateSpecialisation
                                                                                                       .create(new TypeUsage(mainClass)));
  ...
  {
    final EnumerationTranslator enumTrans = mainTranslator.getTypes().getEnumerateTranslator(enumerate.getTypeDeclaration());
    ...
    write.getCode()
         .appendStatement(new Function("write").asFunctionCall(Std.static_cast(new TypeUsage(FundamentalType.INT))
                                                                  .asFunctionCall(enumTrans.getGetIndex().asFunctionCall(value,
                                                                                                                         false)))
                                               .asStatement());
  ...
  private Function addEnumerationReader ( final EnumerateType enumerate )
  {
    ...
    final Expression newValue = enumTrans.getMainClass().callConstructor(enumTrans.getIndexEnum()
                                                                                  .callConstructor(index.asExpression()));
  ...
  private Expression getDomainId ( final String domainName )
  {
    return new Function("getId").asFunctionCall(new Function("getDomain").asFunctionCall(Architecture.process,
                                                                                         false,
                                                                                         Literal
                                                                                                .createStringLiteral(domainName)),
                                                false);
  }
