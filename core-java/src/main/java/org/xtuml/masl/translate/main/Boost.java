...
import org.xtuml.masl.cppgen.FunctionPtrType;
...
public final class Boost
{
  ...
  public final static Expression lexicalCast ( final TypeUsage to, final Expression from )
  {
  ...
  public final static Class getHashType ( final TypeUsage type )
  {
  ...
  public final static Class unordered_map ( final TypeUsage key, final TypeUsage value )
  {
  ...
  public final static Class unordered_set ( final TypeUsage key )
  {
  ...
  public final static Class array ( final TypeUsage of, final Expression size )
  {
  ...
  public final static Class getSharedPtrType ( final TypeUsage type )
  {
  ...
  public final static Class getTupleType ( final List<TypeUsage> types )
  {
  ...
  public final static Class lessThanComparable ( final TypeUsage type )
  {
  ...
  public final static Class lessThanComparable ( final TypeUsage type, final Class chained )
  {
    final Class ret = new Class("less_than_comparable", NAMESPACE, operatorInc);
    ret.addTemplateSpecialisation(type);
  ...
  public final static Class equalityComparable ( final TypeUsage type )
  {
  ...
  public final static Class equalityComparable ( final TypeUsage type, final Class chained )
  {
    final Class ret = new Class("equality_comparable", NAMESPACE, operatorInc);
    ret.addTemplateSpecialisation(type);
    ret.addTemplateSpecialisation(new TypeUsage(chained));
  ...
  public final static Class incrementable ( final TypeUsage type )
  {
  ...
  public final static Class incrementable ( final TypeUsage type, final Class chained )
  {
    final Class ret = new Class("incrementable", NAMESPACE, operatorInc);
    ret.addTemplateSpecialisation(type);
    ret.addTemplateSpecialisation(new TypeUsage(chained));
  ...
  public final static Class decrementable ( final TypeUsage type )
  {
  ...
  public final static Class decrementable ( final TypeUsage type, final Class chained )
  {
    final Class ret = new Class("decrementable", NAMESPACE, operatorInc);
    ret.addTemplateSpecialisation(type);
    ret.addTemplateSpecialisation(new TypeUsage(chained));
  ...
  public final static Class functionClass ( final TypeUsage returnType, final List<TypeUsage> paramTypeList )
  {
