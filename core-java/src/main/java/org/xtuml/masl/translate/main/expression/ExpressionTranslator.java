//
// File: ExpressionStatementTranslator.java
//
...
public abstract class ExpressionTranslator
{
  ...
  public static ExpressionTranslator createTranslator ( final Expression expression, final Scope scope, final BasicType requiredType )
  {
    return createTranslator(expression, scope, requiredType, null);
  }

  public static ExpressionTranslator createTranslator ( final Expression expression, final Scope scope, final Expression assignedTo )
  {
                                                        ...
                                                        final Expression assignedTo )
  {
    ...
    throw new IllegalArgumentException("Unrecognised Expression '" + expression + "' of " + expression.getClass().toString());
  }
  ...
  public org.xtuml.masl.cppgen.Expression getWriteExpression ( final org.xtuml.masl.cppgen.Expression rhs )
  {
    ...
    {
      return new org.xtuml.masl.cppgen.BinaryExpression(writeExpression, org.xtuml.masl.cppgen.BinaryOperator.ASSIGN, rhs);
    }
    else
    {
      if ( writeBase != null )
  ...
  public void setWriteFunction ( final Function function, final org.xtuml.masl.cppgen.Expression base, final boolean pointer )
  {
