/*
 * Filename : SubTypeRelationshipMapperSqlClass.java
 * 
...
public class SubTypeRelationshipMapperSqlClass extends BinaryRelationshipMapperSqlClass
{
   ...
   * specification.
   */
  private static List<SubtypeRelationshipDeclaration> createTableGeneratedList = new ArrayList<SubtypeRelationshipDeclaration>();
  ...
  {
    super(parent, baseClass, getSqlGeneratorClassName(relationshipDecl, derivedObject), relationshipDecl, parentNamespace);
    this.derivedObject = derivedObject;
    this.subtypeRelDecl = relationshipDecl;
    setTypeColumnValue();

    subtypeTableTranslator = databaseTraits.createSubTypeRelationshipToTableTranslator(relationshipDecl, derivedObject);
    linkPreparedStatement = subtypeTableTranslator.createPreparedStatement(PreparedStatement.PreparedStatementType.INSERT);
    unlinkPreparedStatement = subtypeTableTranslator.createPreparedStatement(PreparedStatement.PreparedStatementType.DELETE);
  ...
  static public String getSqlGeneratorClassName ( final SubtypeRelationshipDeclaration relationshipDecl,
                                                  final ObjectDeclaration derivedObject )
  {
    return "Relationship" + relationshipDecl.getName()
  ...
  protected void addDatabaseTable ()
  {
    ...
    if ( createTableGeneratedList.contains(subtypeRelDecl) == false )
    {
  ...
  {
    return Literal.createStringLiteral("DELETE FROM " + getTableName()
                                       + " WHERE "
                                       + getTypeColumnName()
                                       + " = "
                                       + typeColumnValue
