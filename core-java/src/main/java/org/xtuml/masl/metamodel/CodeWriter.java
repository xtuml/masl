...
public class CodeWriter extends AbstractASTNodeVisitor<Void, Void>
{
  ...
  @Override
  public Void visitDictionaryContainsExpression ( final DictionaryContainsExpression node, final Void p ) throws Exception
  {
    return null;
  }
  ...
  private void visit ( final Collection<? extends ASTNode> nodes, final String prefix, final String separator, final String suffix ) throws Exception
  {
    if ( nodes.size() > 0 )
    {
      write(prefix);
  ...
  @Override
  public Void visitFindAttributeNameExpression ( final FindAttributeNameExpression node, final Void p ) throws Exception
  {
    return null;
  }
  ...
  {
    write(PARAM_ALIGNER + node.getName()
          + PARAM_ALIGNER
          + " : "
  ...
  @Override
  public Void visitReferentialAttributeDefinition ( final ReferentialAttributeDefinition node, final Void p ) throws Exception
  {
    return null;
  }
  ...
  @Override
  public Void visitSelectedAttributeExpression ( final SelectedAttributeExpression node, final Void p ) throws Exception
  {
    return null;
  }

  @Override
  public Void visitSelectedComponentExpression ( final SelectedComponentExpression node, final Void p ) throws Exception
  {
    return null;
  }
  ...
  @Override
  public Void visitStructureOrderingExpression ( final StructureOrderingExpression node, final Void p ) throws Exception
  {
    return null;
  }
  ...
  @Override
  public Void visitTerminatorFunctionInvocation ( final TerminatorFunctionInvocation node, final Void p ) throws Exception
  {
    return null;
  }
  ...
  @Override
  public Void visitTerminatorServiceInvocation ( final TerminatorServiceInvocation node, final Void p ) throws Exception
  {
    return null;
  }
  ...
  @Override
  public Void vistAssociativeRelationshipDeclaration ( final AssociativeRelationshipDeclaration node, final Void p ) throws Exception
  {
    return null;
  }

  @Override
  public Void vistNormalRelationshipDeclaration ( final NormalRelationshipDeclaration node, final Void p ) throws Exception
  {
    pushBlock();
  ...
  @Override
  public Void vistSubtypeRelationshipDeclaration ( final SubtypeRelationshipDeclaration node, final Void p ) throws Exception
  {
    return null;
  }
  ...
  private static String align ( final String text, final String delimiter )
  {
    ...
    for ( final String[] lineCol : lineCols )
    {
      ...
      {
        result.append(SPACES.substring(0, colWidths[c - 1] - lineCol[c - 1].length()));
