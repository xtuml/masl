...
public final class TextUtils
{
  ...
  public static class CombineFormatter<T>
  ...
  public static class ToStringFormatter<T>
      implements Formatter<T>
  {
  ...
  public static class WrapFormatter<T>
      implements Formatter<T>
  {
  ...
  public final static String alignTabs ( final String text )
  {
    return alignText(text, '\t');
  }


  public final static String alignText ( final String text, final char align )
  {
  ...
  public final static void alignTabs ( final Writer writer, final String text ) throws IOException
  {
    alignText(writer, text, '\t');
  }

  public final static void alignText ( final Writer writer, final String text, final char align ) throws IOException
  {
    ...
    while ( nextNewLine != -1 )
    {
      ...
      while ( nextTab != -1 && nextTab < nextNewLine )
      {
        ...
        if ( newOffset > oldOffset )
        {
          if ( tabNo < tabOffsets.size() )
          {
            tabOffsets.set(tabNo, new Integer(newOffset));
          }
          else
          {
            tabOffsets.add(new Integer(newOffset));
          }
        }
  ...
  public final static String filledString ( final char c, final int length )
  {
  ...
  public final static <T> String formatList ( final Collection<T> values,
                                              final String prefix,
  ...
  public final static <T> String formatList ( final Collection<T> values,
                                              ...
                                              final String suffix )
  {
    return formatList(values, prefix, new WrapFormatter<T>(valPrefix, new ToStringFormatter<T>(), valSuffix), separator, suffix);
  }

  public final static <V> String formatList ( final Collection<V> values,
                                              final String prefix,
  ...
  public final static <T> void formatList ( final Writer writer,
  ...
  public final static <T> void formatList ( final Writer writer,
                                            ...
                                            final String suffix ) throws IOException
  {
    formatList(writer, values, prefix, new WrapFormatter<T>(valPrefix, new ToStringFormatter<T>(), valSuffix), separator, suffix);
  }

  public final static <V> void formatList ( final Writer writer,
  ...
  public final static String getPadding ( final String text )
  {
    return manySpaces.substring(0, text.length());
  }

  public final static String indentText ( final String indent, final String text )
  {
    final Writer writer = new StringWriter();
    try
    {
  ...
  public final static void indentText ( final Writer writer, final String indent, final String text ) throws IOException
  {
    int start = 0;
  ...
  public final static String lowerFirst ( final String text )
  {
    return text.length() > 1 ? Character.toLowerCase(text.charAt(0)) + text.substring(1)
                            : text.length() == 1 ? String
                                                         .valueOf(Character.toLowerCase(text.charAt(0))) : text;
  }
                                 ...
                                 final boolean wrap ) throws IOException
  {
    if ( linePrefix != null )
    {
      ...
      final BufferedReader reader = new BufferedReader(new StringReader(text.toString()));
  ...
  public final static String upperFirst ( final String text )
  {
    return text.length() > 1 ? Character.toUpperCase(text.charAt(0)) + text.substring(1)
                            : text.length() == 1 ? String
                                                         .valueOf(Character.toUpperCase(text.charAt(0))) : text;
  }

  public final static String wrapLine ( final String firstLinePrefix, final String text )
  {
    final Writer writer = new StringWriter();
    try
    {
  ...
  public final static String wrapLine ( final String firstLinePrefix, final String text, final String continueLinePrefix )
  {
    final Writer writer = new StringWriter();
    try
    {
  ...
  public final static void wrapLine ( final Writer writer, final String firstLinePrefix, final String text ) throws IOException
  {
    wrapLine(writer, firstLinePrefix, text, getPadding(firstLinePrefix));
  }

  public final static void wrapLine ( final Writer writer,
