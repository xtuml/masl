...
public class TestUnlinkExpression extends TestCase
{
                            ...
                            final Expression assignTo )
  {
    ...
    final LinkUnlinkExpression result = LinkUnlinkExpression.create(null,
  ...
  {
    ErrorLog.getInstance().reset();
    LinkUnlinkExpression.create(null, LinkUnlinkExpression.UNLINK, lhs, RelationshipSpecification.createReference(lhs,
                                                                                                                  relRef,
                                                                                                                  objOrRole,
                                                                                                                  obj,
                                                                                                                  false,
