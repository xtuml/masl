...
public abstract class TestConvertible extends TestCase
{
  ...
  private static Set<TypedExpression> charExpressions              = new HashSet<TypedExpression>(Arrays
                                                                                                        .asList(new TypedExpression[]
                                                                                                          {
  ...
  private static Set<TypedExpression> integerExpressions           = new HashSet<TypedExpression>(Arrays
                                                                                                        .asList(new TypedExpression[]
                                                                                                          {
                                                                                                          expr.anonBByte,
                                                                                                          expr.anonBInteger,
  ...
  private static Set<TypedExpression> realExpressions              = new HashSet<TypedExpression>(Arrays
                                                                                                        .asList(new TypedExpression[]
                                                                                                          {
                                                                                                          expr.anonBByte,
                                                                                                          expr.anonBInteger,
  ...
  private static Set<TypedExpression> seqOfIntegerExpressions      = new HashSet<TypedExpression>(Arrays
                                                                                                        .asList(new TypedExpression[]
                                                                                                          {
  ...
  private static Set<TypedExpression> seqOfRealExpressions         = new HashSet<TypedExpression>(Arrays
                                                                                                        .asList(new TypedExpression[]
                                                                                                          {
                                                                                                          expr.anonBagOfAnonInt,
                                                                                                          expr.anonBagOfInt,
  ...
  private static Set<TypedExpression> seqOfCharExpressions         = new HashSet<TypedExpression>(Arrays
                                                                                                        .asList(new TypedExpression[]
                                                                                                          {
                                                                                                          expr.anonBCharacter,
                                                                                                          expr.anonBCharacter,
  ...
  private static Set<TypedExpression> seqOfSeqOfIntegerExpressions = new HashSet<TypedExpression>(Arrays
                                                                                                        .asList(new TypedExpression[]
                                                                                                          {
  ...
  private static Set<TypedExpression> seqOfSeqOfRealExpressions    = new HashSet<TypedExpression>(Arrays
                                                                                                        .asList(new TypedExpression[]
                                                                                                          {
  ...
  public static class UdComplexStructConvertible extends TestConvertible
  {
    ...
    {
      super(types.udComplexStructType, expr.namedUdComplexStructType, expr.anonAnonComplexStruct, expr.anonAnonComplexAnonStruct);
    }
  }
  ...
  {
    final String message = targetType + " ( "
