...
public abstract class TestAssignment extends TestCase
{
  ...
  public static class UdIntTypeConstrainedTypeAssignment extends TestAssignment
  {
    ...
    {
      super(types.udIntTypeConstrainedType, expr.namedUdIntTypeConstrainedType, expr.anonBInteger, expr.anonBByte);
    }
  }
  ...
  public static class UdSimpleStructAssignment extends TestAssignment
  {
    ...
    {
      super(types.udSimpleStructType, expr.namedUdSimpleStructType, expr.anonAnonSimpleStruct, expr.anonAnonSimpleAnonStruct);
    }
  }
  ...
  {
    final String message = targetType + " := " + (assignable.getType().isAnonymousType() ? "anon " : "") + assignable.getType();
