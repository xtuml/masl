...
public class TestExpressions
{
  ...
  private TestExpressions ( final TestTypes types )
  {
    ...
    anonAnonTrivialAnonStruct = new TypedExpression(new AnonymousStructure(Arrays.asList(new BasicType[]
      {
                                                                                 IntegerType.createAnonymous() })));

    anonAnonSimpleAnonStruct = new TypedExpression(new AnonymousStructure(Arrays.asList(new BasicType[]
      {
          IntegerType.createAnonymous(),
    ...
    anonAnonSimpleAnonStruct2 = new TypedExpression(new AnonymousStructure(Arrays.asList(new BasicType[]
      {
          IntegerType.createAnonymous(),
          StringType.createAnonymous(),
          WStringType.createAnonymous(),
    ...
    anonAnonComplexAnonStruct = new TypedExpression(new AnonymousStructure(Arrays.asList(new BasicType[]
      {
          types.anonSimpleStruct,
          SequenceType.createAnonymous(types.bInteger),
