...
public class TestConcatenateExpression extends TestCase {
    ...
    public void checkResult(final Expression lhs,
    ...
    public void test_CharA_CharB() {
        checkResult(exprA.namedUdCharacterType,
                    exprB.namedUdCharacterType,
    ...
    public void test_StringA_CharA() {
        checkResult(exprA.namedUdStringType,
                    exprA.namedUdCharacterType,
                    SemanticErrorCode.OperatorOperandsNotCompatible);
    }
