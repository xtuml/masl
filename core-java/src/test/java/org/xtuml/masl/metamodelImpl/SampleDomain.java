...
public class SampleDomain
{
  ...
  static
  {
    NormalRelationshipDeclaration.create(null,
                                         ...
                                         HalfRelationship.create(refB, true, "to right of", MultiplicityType.ONE, refA),
                                         new PragmaList());
    ...
    AssociativeRelationshipDeclaration.create(null,
                                              ...
                                              "R5",
                                              HalfRelationship.create(refA, true, "to left of", MultiplicityType.MANY, refB),
                                              HalfRelationship.create(refB, true, "to right of", MultiplicityType.MANY, refA),
                                              refE,
                                              new PragmaList());
    ...
    final ArrayList<ReferentialAttributeDefinition> refAttList_R1R2 = new ArrayList<ReferentialAttributeDefinition>();
    refAttList_R1R2.add(ReferentialAttributeDefinition.create(objA,
                                                              RelationshipSpecification.createReference(new ObjectNameExpression(null,
                                                                                                                                 objB),
                                                                                                        RelationshipDeclaration.createReference(domainRef,
                                                                                                                                                "R1"),
                                                                                                        "A",
                                                                                                        refA,
                                                                                                        false,
    ...
    final ArrayList<ReferentialAttributeDefinition> refAttList_R3A = new ArrayList<ReferentialAttributeDefinition>();
    refAttList_R3A.add(ReferentialAttributeDefinition.create(objA,
                                                             RelationshipSpecification.createReference(new ObjectNameExpression(null,
                                                                                                       ...
                                                                                                       false),
                                                             "id"));
    final ArrayList<ReferentialAttributeDefinition> refAttList_R3B = new ArrayList<ReferentialAttributeDefinition>();
    ...
    final ArrayList<ReferentialAttributeDefinition> refAttList_R4A = new ArrayList<ReferentialAttributeDefinition>();
    refAttList_R4A.add(ReferentialAttributeDefinition.create(objA,
                                                             RelationshipSpecification.createReference(new ObjectNameExpression(null,
                                                                                                       ...
                                                                                                       false),
                                                             "id"));
    final ArrayList<ReferentialAttributeDefinition> refAttList_R4B = new ArrayList<ReferentialAttributeDefinition>();
    ...
    final ArrayList<ReferentialAttributeDefinition> refAttList_R5A = new ArrayList<ReferentialAttributeDefinition>();
    refAttList_R5A.add(ReferentialAttributeDefinition.create(objA,
                                                             RelationshipSpecification.createReference(new ObjectNameExpression(null,
                                                                                                       ...
                                                                                                       false),
                                                             "id"));
    final ArrayList<ReferentialAttributeDefinition> refAttList_R5B = new ArrayList<ReferentialAttributeDefinition>();
    ...
    final ArrayList<ReferentialAttributeDefinition> refAttList_R6A = new ArrayList<ReferentialAttributeDefinition>();
    refAttList_R6A.add(ReferentialAttributeDefinition.create(objA,
                                                             RelationshipSpecification.createReference(new ObjectNameExpression(null,
                                                                                                       ...
                                                                                                       false),
                                                             "id"));
    final ArrayList<ReferentialAttributeDefinition> refAttList_R6B = new ArrayList<ReferentialAttributeDefinition>();
    ...
    final ArrayList<ReferentialAttributeDefinition> refAttList_R7A = new ArrayList<ReferentialAttributeDefinition>();
    refAttList_R7A.add(ReferentialAttributeDefinition.create(objA,
                                                             RelationshipSpecification.createReference(new ObjectNameExpression(null,
                                                                                                       ...
                                                                                                       false),
                                                             "id"));
    final ArrayList<ReferentialAttributeDefinition> refAttList_R7B = new ArrayList<ReferentialAttributeDefinition>();
    ...
    final ArrayList<ReferentialAttributeDefinition> refAttList_R8A = new ArrayList<ReferentialAttributeDefinition>();
    refAttList_R8A.add(ReferentialAttributeDefinition.create(objA,
                                                             RelationshipSpecification.createReference(new ObjectNameExpression(null,
                                                                                                       ...
                                                                                                       false),
                                                             "id"));
    final ArrayList<ReferentialAttributeDefinition> refAttList_R8B = new ArrayList<ReferentialAttributeDefinition>();
  ...
  static public final VariableDefinition                singleAdef  = VariableDefinition.create("varA",
                                                                                                singleAType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                singleBdef  = VariableDefinition.create("varB",
                                                                                                singleBType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                singleCdef  = VariableDefinition.create("varC",
                                                                                                singleCType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                singleDdef  = VariableDefinition.create("varD",
                                                                                                singleDType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                singleEdef  = VariableDefinition.create("varE",
                                                                                                singleEType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                singleFdef  = VariableDefinition.create("varF",
                                                                                                singleFType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                singleGdef  = VariableDefinition.create("varG",
                                                                                                singleGType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                singleHdef  = VariableDefinition.create("varH",
                                                                                                singleHType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                collAdef    = VariableDefinition.create("collA",
                                                                                                collAType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                collBdef    = VariableDefinition.create("varB",
                                                                                                collBType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                collCdef    = VariableDefinition.create("collB",
                                                                                                collCType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                collDdef    = VariableDefinition.create("collB",
                                                                                                collDType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                collEdef    = VariableDefinition.create("collB",
                                                                                                collEType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                collFdef    = VariableDefinition.create("collF",
                                                                                                collFType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                collGdef    = VariableDefinition.create("collG",
                                                                                                collGType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
  ...
  static public final VariableDefinition                collHdef    = VariableDefinition.create("collH",
                                                                                                collHType,
                                                                                                false,
                                                                                                null,
                                                                                                new PragmaList());
