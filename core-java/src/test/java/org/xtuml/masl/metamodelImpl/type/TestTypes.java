...
import org.xtuml.masl.metamodelImpl.type.ByteType;
...
public final class TestTypes
{
  ...
  private TestTypes ( final String prefix )
  {
    ...
    udWCharacterTypeDecl = TypeDeclaration.create(null,
                                                  domain,
    ...
    udWStringTypeDecl = TypeDeclaration.create(null,
                                               domain,
                                               prefix + "udWStringType",
                                               Visibility.PUBLIC,
                                               bWString,
                                               pragmas);
    ...
    udIntTypeTypeDecl = TypeDeclaration.create(null, domain, prefix + "udIntTypeType", Visibility.PUBLIC, udIntType, pragmas);
    ...
    udIntConstrainedTypeDecl = TypeDeclaration.create(null,
                                                      domain,
    ...
    udIntTypeConstrainedTypeDecl = TypeDeclaration.create(null,
                                                          domain,
                                                          prefix + "udIntTypeConstrainedType",
                                                          Visibility.PUBLIC,
                                                          new ConstrainedType(udIntType, new RangeConstraint(oneToTen)),
                                                          pragmas);
    udIntTypeConstrainedType = UserDefinedType.create(domain.getReference(null), prefix + "udIntTypeConstrainedType");
    ...
    udSeqOfIntTypeDecl = TypeDeclaration.create(null, domain, prefix + "udSeqOfIntType", Visibility.PUBLIC, seqOfInt, pragmas);
    udSeqOfIntType = UserDefinedType.create(domain.getReference(null), prefix + "udSeqOfIntType");


    udSetOfIntTypeDecl = TypeDeclaration.create(null, domain, prefix + "udSetOfIntType", Visibility.PUBLIC, setOfInt, pragmas);
    udSetOfIntType = UserDefinedType.create(domain.getReference(null), prefix + "udSetOfIntType");


    udBagOfIntTypeDecl = TypeDeclaration.create(null, domain, prefix + "udBagOfIntType", Visibility.PUBLIC, bagOfInt, pragmas);
    udBagOfIntType = UserDefinedType.create(domain.getReference(null), prefix + "udBagOfIntType");


    udArray3to3OfIntTypeDecl = TypeDeclaration.create(null,
                                                      domain,
    ...
    udArray1to10OfIntTypeDecl = TypeDeclaration.create(null,
                                                       domain,
    ...
    udArray2to11OfIntTypeDecl = TypeDeclaration.create(null,
                                                       domain,
    ...
    trivialStruct = StructureType.create(null, Arrays.asList(new StructureElement[]
      { StructureElement.create("elt",
                                udIntType,
                                null,
                                pragmas) }));


    udTrivialStructTypeDecl = TypeDeclaration.create(null,
                                                     domain,
    ...
    anonTrivialStruct = new AnonymousStructure(Arrays.asList(new BasicType[]
      { udIntType }));


    simpleStruct = StructureType.create(null, Arrays.asList(new StructureElement[]
      {
          StructureElement.create("elt1", bInteger, null, pragmas),
    ...
    udSimpleStructTypeDecl = TypeDeclaration.create(null,
                                                    domain,
    ...
    anonSimpleStruct = new AnonymousStructure(Arrays.asList(new BasicType[]
      {
          bInteger,
          bString,
          bWString,
    ...
    complexStruct = StructureType.create(null, Arrays.asList(new StructureElement[]
      {
          StructureElement.create("elt1", udSimpleStructType, null, pragmas),
          StructureElement.create("elt2", seqOfInt, null, pragmas),
          StructureElement.create("elt3", seqOfSeqOfInt, null, pragmas) }));


    udComplexStructTypeDecl = TypeDeclaration.create(null,
                                                     domain,
    ...
    anonComplexStruct = new AnonymousStructure(Arrays.asList(new BasicType[]
      { udSimpleStructType, seqOfInt, seqOfSeqOfInt }));


    primaryColours = EnumerateType.create(null, Arrays.asList(new EnumerateItem[]
      {
          new EnumerateItem("red"),
          new EnumerateItem("green"),
          new EnumerateItem("blue"), }));


    udPrimaryColoursDecl = TypeDeclaration.create(null,
                                                  domain,
    ...
    rainbowColours = EnumerateType.create(null, Arrays.asList(new EnumerateItem[]
      {
          new EnumerateItem("red"),
    ...
    udRainbowColoursDecl = TypeDeclaration.create(null,
                                                  domain,
