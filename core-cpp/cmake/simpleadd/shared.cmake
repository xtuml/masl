...
function(simple_add_shared_library)
    cmake_parse_arguments(
        PARSE_ARGV 0
        ARGS
            "INSTALL;FIXPROTOINC;NOWARNERROR"                               #Name only args
            "NAME;LIBNAME;EXPORT;VERSION;SOVERSION;SRCDIR;INCDIR;OUTDIR"    #Name value args
            "LINKS;SOURCES;INCLUDES"                                        #Name multi value args
    )

    message(STATUS "NOWARNERROR: '${ARGS_NOWARNERROR}'")
    ...
    if (DEFINED ARGS_OUTDIR)
        set_property(
            TARGET ${ARGS_NAME}
            PROPERTY LIBRARY_OUTPUT_DIRECTORY ${ARGS_OUTDIR}
        )
    else ()
        set_property(
            TARGET ${ARGS_NAME}
            PROPERTY LIBRARY_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR}/${INSTALL_LIB_DIR}
        )
    endif ()
