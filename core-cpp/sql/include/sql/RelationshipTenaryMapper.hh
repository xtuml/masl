...
//
// File:  RelationshipTenaryMapper.hh 
//
//============================================================================//

#ifndef Sql_RelationshipTenaryMapper_HH
#define Sql_RelationshipTenaryMapper_HH
...
#include "RelationshipTenarySqlGenerator.hh"
#include "RelationshipAssociativeContainers.hh"
#include "RelationshipTenaryMapperUnitOfWork.hh"

namespace SQL {

// ***********************************************************************
//! @brief Generic class to handle o-to-m and m-to-o relationship specifications.
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
class RelationshipTenaryMapper : public ResourceMonitorObserver
{
    public:
       enum { identity  = rel };
       ...
       typedef RelationshipTenarySqlGenerator<LhsRelContainer,RhsRelContainer,AssRelContainer> RelSqlGeneratorType;
       typedef RelationshipTenaryMapperUnitOfWork<RelationshipTenaryMapper>                    UnitOfWorkType;

    public:

       static RelationshipTenaryMapper& singleton();
       ...
       void unlinkFromLhsToRhs (const LhsPsObjectPtr& lhsObj, const RhsPsObjectPtr& rhsObj, const AssPsObjectPtr& assObj); 
       void unlinkFromRhsToLhs (const RhsPsObjectPtr& rhsObj, const LhsPsObjectPtr& lhsObj, const AssPsObjectPtr& assObj);
    ...
    private:
        RelationshipTenaryMapper(const RelationshipTenaryMapper& rhs);
        RelationshipTenaryMapper& operator=(const RelationshipTenaryMapper& rhs);
    ...
    private:
         ...
         typedef boost::unordered_map< ::SWA::IdType, RhsRelContainer > LhsLinksType;
         typedef boost::unordered_map< ::SWA::IdType, LhsRelContainer > RhsLinksType;
         typedef boost::unordered_map< ::SWA::IdType, AssRelContainer > AssLinksType;
         ...
         typename RelSqlGeneratorType::CachedTenaryContainerSet cachedContainerHandle;
};

// ***********************************************************************
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::RelationshipTenaryMapper():
      allLoaded(false),
      loadOnDemand(false),
      writeOnChange(false),
      unitOfWork(*this),
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>&
RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::singleton() 
{
   static RelationshipTenaryMapper instance;
   return instance;
}
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::displayAllLinks(const std::string& location)
{
...
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
template <class T>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::displayContainer(const std::string& label, T& container)
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::initialise(const ::boost::shared_ptr<RelSqlGeneratorType>& generator) 
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::forceFlush()
{
  unitOfWork.flush(); 
}
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
bool RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::isInitialised() const
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::setToLoadOnDemand(bool isEnabled)
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::linkFromLhsToRhs (const LhsPsObjectPtr& lhsObj,  const RhsPsObjectPtr& rhsObj, const AssPsObjectPtr& assObj) 
{  
   ...
   RelationshipAtomicity<LhsLinksType,RhsPsObjectPtr,AssPsObjectPtr,LinkPolicy> atomicLhsLinks(lhsLinks,lhsObjId,rhsObj,assObj);
   RelationshipAtomicity<RhsLinksType,LhsPsObjectPtr,AssPsObjectPtr,LinkPolicy> atomicRhsLinks(rhsLinks,rhsObjId,lhsObj,assObj);
   RelationshipAtomicity<AssLinksType,LhsPsObjectPtr,RhsPsObjectPtr,LinkPolicy> atomicAssLinks( assLinks,assObjId,lhsObj,rhsObj);
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::linkFromRhsToLhs(const RhsPsObjectPtr& rhsObj, const LhsPsObjectPtr& lhsObj, const AssPsObjectPtr& assObj)
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::unlinkFromLhsToRhs  (const LhsPsObjectPtr& lhsObj,  const RhsPsObjectPtr& rhsObj, const AssPsObjectPtr& assObj) 
{ 
   const ::SWA::IdType& lhsObjId = lhsObj.getChecked()->getArchitectureId();
   const ::SWA::IdType& rhsObjId = rhsObj.getChecked()->getArchitectureId();
   const ::SWA::IdType& assObjId = assObj.getChecked()->getArchitectureId();
   ...
   RelationshipAtomicity<LhsLinksType,RhsPsObjectPtr,AssPsObjectPtr,UnlinkPolicy> atomicLhsUnlinks(lhsLinks,lhsObjId,rhsObj,assObj);
   RelationshipAtomicity<RhsLinksType,LhsPsObjectPtr,AssPsObjectPtr,UnlinkPolicy> atomicRhsUnlinks(rhsLinks,rhsObjId,lhsObj,assObj);
   RelationshipAtomicity<AssLinksType,LhsPsObjectPtr,RhsPsObjectPtr,UnlinkPolicy> atomicAssUnlinks(assLinks,assObjId,lhsObj,rhsObj);
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void  RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::unlinkFromRhsToLhs (const RhsPsObjectPtr& rhsObj, const LhsPsObjectPtr& lhsObj, const AssPsObjectPtr& assObj)
{ 
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedAssType 
 RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::correlateFromLhsToRhs (const LhsPsObjectPtr& lhsObj, const RhsPsObjectPtr& rhsObj)
{
   // Check that the required link data is loaded before
   // undertaking any kind of processing on the cache. 
...
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedAssType 
 RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::correlateFromRhsToLhs (const RhsPsObjectPtr& rhsObj, const LhsPsObjectPtr& lhsObj)
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
::std::size_t RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::countFromLhsToRhs(const LhsPsObjectPtr& lhsObj)
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
::std::size_t RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::countFromLhsToAss(const LhsPsObjectPtr& lhsObj)
{
   loadLhsToRhsLinks (lhsObj.getChecked()->getArchitectureId());
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
::std::size_t RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::countFromRhsToLhs(const RhsPsObjectPtr& rhsObj)
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
::std::size_t RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::countFromRhsToAss(const RhsPsObjectPtr& rhsObj)
{
   loadRhsToLhsLinks (rhsObj.getChecked()->getArchitectureId());
   typename RhsLinksType::iterator rhsLinksItr = rhsLinks.find(rhsObj.getChecked()->getArchitectureId());
   return rhsLinksItr != rhsLinks.end() ? rhsLinksItr->second.linkCount() : 0;
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
::std::size_t RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::countFromAssToLhs(const AssPsObjectPtr& assObj)
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
::std::size_t RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::countFromAssToRhs(const AssPsObjectPtr& assObj)
{
   loadAssociativeLinks (assObj.getChecked()->getArchitectureId());
   typename AssLinksType::iterator assLinksItr = assLinks.find(assObj.getChecked()->getArchitectureId());
   return assLinksItr != assLinks.end() ? assLinksItr->second.linkCount() : 0;
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::abortLinks()
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::commitLinks (const typename UnitOfWorkType::LinkHashSetType& objects)
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::commitUnlinks (const typename UnitOfWorkType::UnLinkHashSetType& objects)
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::objectDeletedLhs (const LhsPsObjectPtr&  lhsObj)
{
   ...
   if (hasLinksLhs(lhsObj) == true){
       ...
       errorMsgStrm << " Found dangling relationship(s) in lhs object of associative relationship R" <<  identity;
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::objectDeletedRhs (const RhsPsObjectPtr& rhsObj)
{
   ...
   if (hasLinksRhs(rhsObj) == true){
       std::ostringstream errorMsgStrm;
       errorMsgStrm << " Found dangling relationship(s) in rhs object of associative relationship R" <<  identity;
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::objectDeletedAss (const AssPsObjectPtr& assObj)
{
   ...
   if (hasLinksAss(assObj) == true){
       std::ostringstream errorMsgStrm;
       errorMsgStrm << " Found dangling relationship(s) in assoc object of associative relationship R" <<  identity;
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
bool RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::hasLinksLhs(const LhsPsObjectPtr&  lhsObj)
{ 
  const ::SWA::IdType architectureId = lhsObj.getChecked()->getArchitectureId();
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
bool RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::hasLinksRhs(const RhsPsObjectPtr& rhsObj)
{ 
  const ::SWA::IdType architectureId = rhsObj.getChecked()->getArchitectureId();
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
bool RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::hasLinksAss(const AssPsObjectPtr& assObj)
{ 
  const ::SWA::IdType architectureId = assObj.getChecked()->getArchitectureId();
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
const typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedRhsType
RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::navigateFromLhsToRhs(const LhsPsObjectPtr& lhsObj) 
{  
   const ::SWA::IdType architectureId = lhsObj.getChecked()->getArchitectureId();
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedSetType  
RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::navigateFromLhsToRhs(const LhsPsObjectPtrSet& lhsObjSet) 
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
const typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedLhsType
RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::navigateFromRhsToLhs(const RhsPsObjectPtr& rhsObj)
{ 
   const ::SWA::IdType architectureId = rhsObj.getChecked()->getArchitectureId();
...
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedSetType 
RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::navigateFromRhsToLhs(const RhsPsObjectPtrSet& rhsObjSet)
{
   NavigatedSetType objectSet;
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
const typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedAssType 
 RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::navigateFromAssToRhs(const AssPsObjectPtr&  assObj)
{
   const ::SWA::IdType architectureId = assObj.getChecked()->getArchitectureId();
...
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedSetType 
 RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::navigateFromAssToRhs(const AssPsObjectPtrSet& assObjSet)
{
   NavigatedSetType objectSet;
...
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
const typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedAssType  
 RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::navigateFromAssToLhs (const AssPsObjectPtr& assObj)
{
   const ::SWA::IdType architectureId = assObj.getChecked()->getArchitectureId();
...
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedSetType 
 RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::navigateFromAssToLhs (const AssPsObjectPtrSet& assObjSet)
{
   NavigatedSetType objectSet;
   typename AssPsObjectPtrSet::const_iterator  objItr = assObjSet.begin();
   typename AssPsObjectPtrSet::const_iterator  endItr = assObjSet.end();
...
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
const typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedLhsType  
 RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::navigateFromRhsToAss(const RhsPsObjectPtr& rhsObj)
{
   const ::SWA::IdType architectureId = rhsObj.getChecked()->getArchitectureId();
...
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedSetType 
 RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::navigateFromRhsToAss(const RhsPsObjectPtrSet& rhsObjSet)
{
   NavigatedSetType objectSet;
   typename RhsPsObjectPtrSet::const_iterator  objItr = rhsObjSet.begin();
   typename RhsPsObjectPtrSet::const_iterator  endItr = rhsObjSet.end();
...
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
const typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedRhsType 
 RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::navigateFromLhsToAss(const LhsPsObjectPtr&  lhsObj)
{
   const ::SWA::IdType architectureId = lhsObj.getChecked()->getArchitectureId();
...
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedSetType 
RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::navigateFromLhsToAss(const LhsPsObjectPtrSet& lhsObjSet)
{
   NavigatedSetType objectSet;
   typename LhsPsObjectPtrSet::const_iterator  objItr = lhsObjSet.begin();
   typename LhsPsObjectPtrSet::const_iterator  endItr = lhsObjSet.end();
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::report  (ResourceMonitorContext& context)
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::compact (ResourceMonitorContext& context)
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::release (ResourceMonitorContext& context)
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::loadAll()
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::clearAll()
{
   allLoaded = false;
   lhsLinks.clear();
   rhsLinks.clear();
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::loadLhsToRhsLinks(const ::SWA::IdType& lhsObjId)
{
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::loadRhsToLhsLinks(const ::SWA::IdType& rhsObjectId)
{
   if (allLoaded == false){
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::loadAssociativeLinks(const ::SWA::IdType& assObjId)
{
   if (allLoaded == false){
...
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedAssType 
 RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::correlate(const NavigatedAssType& lhsAssObjId, const NavigatedAssType& rhsAssObjId)
{
...
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedAssType 
 RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::correlate(const NavigatedAssType& lhsAssObjId, const NavigatedSetType& rhsAssObjIdSet)
{
...
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedAssType 
 RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::correlate(const NavigatedSetType& lhsAssObjIdSet, const NavigatedAssType& rhsAssObjId)
{
...
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
typename RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::NavigatedAssType 
 RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::correlate(const NavigatedSetType& lhsAssObjIdSet, const NavigatedSetType& rhsAssObjIdSet)
{
   NavigatedSetType intersectedSet;
   std::set_intersection(lhsAssObjIdSet.begin(),lhsAssObjIdSet.end(),rhsAssObjIdSet.begin(),rhsAssObjIdSet.end(),associativeInserter(intersectedSet));
...
// ***********************************************************************
template <int rel, class LhsRelContainer, class RhsRelContainer, class AssRelContainer, bool OneC, bool ManyC>
void RelationshipTenaryMapper<rel,LhsRelContainer,RhsRelContainer,AssRelContainer,OneC,ManyC>::flush ()
{
