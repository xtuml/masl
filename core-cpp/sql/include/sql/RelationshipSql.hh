...
class RelationshipSql
{
   public:
    ...
    virtual const std::string   getAssocColumnName  () const { throw SqlException(::boost::make_tuple("RelationshipSql::getAssocColumnName : invalid call for relationship ",getDomainName(),getRelationshipName())); }
