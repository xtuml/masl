...
// Filename : Schema.cc
//
// UK Crown Copyright () 2007. All Rights Reserved
//
//============================================================================//
...
template <class T>
class SchemaFormation : public std::unary_function<typename T::value_type,void>
{
    public:
...
// table sql statements.
template <class T>
class DropFormation : public std::unary_function<typename T::value_type, void>
{
    public:
