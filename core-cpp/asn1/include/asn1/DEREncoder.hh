  ...
  namespace DER
  {
    ...
    class Encoder
    {
      public:
        ...
        class iterator : public boost::input_iterator_helper<iterator, Octet, std::ptrdiff_t, const Octet*, const Octet&>
        {
          public:
            struct Position
            {
            ...
            Octet operator*() const {  return static_cast<Octet>(*stack.top().it); }
            iterator& operator++();
        ...
        size_t size() const;
        void reserve ( size_t noChildren ) { children.reserve(noChildren); }
