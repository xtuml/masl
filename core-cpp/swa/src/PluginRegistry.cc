...
namespace SWA
{
  ...
  class KeyIterator : public std::iterator<std::input_iterator_tag, typename InnerIterator::value_type::first_type>, public boost::input_iteratable<KeyIterator<InnerIterator>,typename InnerIterator::value_type::first_type*>
  {
    public:
