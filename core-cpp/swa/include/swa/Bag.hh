...
namespace SWA
{
                      ...
                      >
  {
    public:
      ...
      template<class T2>
      explicit Bag ( const boost::unordered_set<T2>& rhs ) : data(rhs.begin(),rhs.end()), unique(true), sorted(false) {}

      template<class T2>
      explicit Bag ( const boost::unordered_multiset<T2>& rhs ) : data(rhs.begin(),rhs.end()), unique(false), sorted(false) {}
