...
//
// Description:    
//     Provide a templated wrapper class around the select system call. The template 
// parameter should be one of the WaitXX classes defined below. This enables the
// Select class to be configured with one of its three allowed timer configurations;
//          WaitForever (blocks) - do not return from the select until a descriptor 
//                                 is activated or an error is reported 
//          
//          Wait    (blocks)     - wait a finite amount of time for a descriptor to be
//                                 activated. Return 0 if time interval expired before
//                                 descriptor is active (blocks).
//
//          NoWait  (not block)  - Check the file desriptor set for an active descriptor and
//                                 return straight away (do not block)
//==========================================================================================//
#include <string>
#include <cerrno>
#include <vector>
