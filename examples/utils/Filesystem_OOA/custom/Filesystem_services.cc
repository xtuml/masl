...
namespace masld_Filesystem
{
                         ...
                         maslt_file&             maslp_dev )
  {
    try
    {
      maslp_dev.setInputStream(boost::make_shared<std::ifstream>(maslp_file_name.c_str(),std::ios::in));
                          ...
                          maslt_file&             maslp_dev )
  {
    try
    {
      ...
      {
        maslp_dev.setInOutStream(boost::make_shared<std::fstream>(maslp_file_name.c_str(),std::ios::in|std::ios::out));
      }
      else
      {
        maslp_dev.setInOutStream(boost::make_shared<std::fstream>(maslp_file_name.c_str(),std::ios::in|std::ios::out|std::ios::trunc));
      }
    }
    catch ( std::ios::failure& e )
    {
                           ...
                           maslt_file&             maslp_dev )
  {
    try
    {
      if ( masls_file_exists(maslp_file_name) )
      {
        maslp_dev.setInOutStream(boost::make_shared<std::fstream>(maslp_file_name.c_str(),std::ios::in|std::ios::out|std::ios::ate));
      }
      else
      {
        maslp_dev.setInOutStream(boost::make_shared<std::fstream>(maslp_file_name.c_str(),std::ios::in|std::ios::out|std::ios::trunc));
  ...
  {
    boost::shared_ptr<std::istream> in = dev.getInputStream<std::istream>();
    if ( !in )
    {
