...
namespace Trace
{
  ...
  bool Trace::initialise()
  {
    ...
    SWA::PluginRegistry::getInstance().registerFlagSetter(getName(),"Events",[this](bool flag){setTraceEvents(flag);});
    SWA::PluginRegistry::getInstance().registerFlagSetter(getName(),"Actions",[this](bool flag){setTraceActions(flag);});
    SWA::PluginRegistry::getInstance().registerFlagSetter(getName(),"Lines",[this](bool flag){setTraceLines(flag);});

    SWA::PluginRegistry::getInstance().registerFlagGetter(getName(),"Events",[this](){return isTraceEvents();});
    SWA::PluginRegistry::getInstance().registerFlagGetter(getName(),"Actions",[this](){return isTraceActions();});
    SWA::PluginRegistry::getInstance().registerFlagGetter(getName(),"Lines",[this](){return isTraceLines();});
