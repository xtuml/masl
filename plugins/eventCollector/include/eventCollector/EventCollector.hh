...
//!
//! This implementation is built into a shared library that is dynamically
//! loaded into a masl process using the -util command line option. Once loaded
//! it will hook into the masl process and start reporting the monitored set of
//! events.
// ******************************************************************************
class EventCollector : public SWA::ProcessMonitor::MonitorConnection {
  ...
  public:
    ...
    // *****************************************************************
    virtual void generatingEvent(int domainId, int objectId, int eventId,
    ...
    //! @param instanceId   the architecture id of the destination object.
    // *****************************************************************
    virtual void processingEvent(int domainId, int objectId, int eventId,
                                 int destObjectId, SWA::IdType instanceId);
    ...
    // *****************************************************************
    virtual void settingTimer(int timerId, const SWA::Timestamp &timeout,
  ...
  private:
    ...
    std::list<std::shared_ptr<EventEncoder>> eventEncoders;
};
