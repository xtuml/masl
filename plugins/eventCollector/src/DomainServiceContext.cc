...
// ***************************************************************
// ***************************************************************
DomainServiceContext::DomainServiceContext(const SWA::StackFrame &frame,
    ...
    if (frame.getType() != SWA::StackFrame::DomainService) {
        throw SWA::ProgramError("Failed to create DomainServiceContext : not a "
...
// ***************************************************************
// ***************************************************************
int DomainServiceContext::getDomainId() const { return domain.getId(); }

// ***************************************************************
// ***************************************************************
int DomainServiceContext::getServiceId() const { return frame.getActionId(); }
...
const std::string DomainServiceContext::getServiceTypeName() const {
    ...
    const SWA::ServiceMetaData &service =
        domain.getService(frame.getActionId());

    switch (service.getType()) {
    case SWA::ServiceMetaData::Scenario:
        serviceType = "scenario";
        break;
    case SWA::ServiceMetaData::External:
        serviceType = "external";
        break;
    case SWA::ServiceMetaData::Domain:
        serviceType = "domain";
        break;
