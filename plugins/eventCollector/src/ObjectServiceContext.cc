...
// ***************************************************************
// ***************************************************************
ObjectServiceContext::ObjectServiceContext(const SWA::StackFrame &frame,
    ...
    if (frame.getType() != SWA::StackFrame::ObjectService) {
        throw SWA::ProgramError(
            "Failed to create ObjectServiceContext : not an object service ");
    }
}
...
// ***************************************************************
// ***************************************************************
int ObjectServiceContext::getDomainId() const { return domain.getId(); }

// ***************************************************************
// ***************************************************************
int ObjectServiceContext::getObjectId() const { return object.getId(); }
...
const std::string ObjectServiceContext::getServiceType() const {
    ...
    case SWA::ServiceMetaData::Object:
        serviceType = "object";
        break;
    case SWA::ServiceMetaData::Instance:
