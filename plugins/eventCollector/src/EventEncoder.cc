...
// ***************************************************************
// ***************************************************************
void EventEncoder::addWriter(const std::shared_ptr<EventWriter> &writer) {
    writers.push_back(writer);
}

// ***************************************************************
// ***************************************************************
void EventEncoder::writeThreadStarted(const ProcessContext &processContext,
...
// ***************************************************************
// ***************************************************************
void EventEncoder::writeDomainService(const ProcessContext &processContext,
...
// ***************************************************************
// ***************************************************************
void EventEncoder::writeTerminatorService(
...
// ***************************************************************
// ***************************************************************
void EventEncoder::writeObjectService(const ProcessContext &processContext,
...
// ***************************************************************
// ***************************************************************
void EventEncoder::writeStateService(const ProcessContext &processContext,
...
// ***************************************************************
// ***************************************************************
void EventEncoder::writeGeneratingEvent(const ProcessContext &processContext,
...
// ***************************************************************
// ***************************************************************
void EventEncoder::writeProcessingEvent(const ProcessContext &processContext,
                                        const EventContext &eventContext) {
    if (aWriterIsEnabled() == true) {
...
// ***************************************************************
// ***************************************************************
void EventEncoder::writeTimerCreated(const ProcessContext &processContext,
...
// ***************************************************************
// ***************************************************************
void EventEncoder::writeTimerDeleted(const ProcessContext &processContext,
                                     const uint32_t timerId) {
    if (aWriterIsEnabled() == true) {
...
// ***************************************************************
// ***************************************************************
void EventEncoder::writeTimerFired(const ProcessContext &processContext,
                                   const uint32_t timerId) {
    if (aWriterIsEnabled() == true) {
...
// ***************************************************************
// ***************************************************************
void EventEncoder::writeTimerCancelled(const ProcessContext &processContext,
                                       const uint32_t timerId) {
    if (aWriterIsEnabled() == true) {
...
// ***************************************************************
// ***************************************************************
void EventEncoder::writeTimerSet(const ProcessContext &processContext,
                                 const uint32_t timerId) {
    if (aWriterIsEnabled() == true) {
...
// ***************************************************************
// ***************************************************************
void EventEncoder::writeFinishedEvent(const ProcessContext &processContext,
...
void EventEncoder::shutdown() {
    std::for_each(writers.begin(), writers.end(),
                  [](const auto &writer) { return writer->shutdown(); });
}
...
bool EventEncoder::aWriterIsEnabled() {
    std::size_t enabledCount =
        std::count_if(writers.begin(), writers.end(),
                      [](const auto &writer) { return writer->isEnabled(); });
    return enabledCount;
}
