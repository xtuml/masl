domain JSONValidation is
  ...
  public type Schema is structure
    metaschema: JSON::JSONElement;
    schema_element: JSON::JSONElement;
  end structure;
  ...
  public service validate(input: in JSON::JSONElement, schema: in Schema) return JSON::JSONObject;
  ...
  public service load_schema(schema_path: in anonymous string) return Schema;
