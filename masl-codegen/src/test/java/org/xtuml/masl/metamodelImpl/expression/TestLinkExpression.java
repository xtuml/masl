...
public class TestLinkExpression extends TestCase {
    ...
    public void checkLink(final Expression lhs, final RelationshipDeclaration.Reference relRef, final String objOrRole,
            final ObjectNameExpression obj, final Expression rhs, final Expression assignTo) {
        ErrorLog.getInstance().reset();
        final LinkUnlinkExpression result = LinkUnlinkExpression.create(null, LinkUnlinkExpression.LINK, lhs,
    ...
    public void checkLink(final Expression lhs, final RelationshipDeclaration.Reference relRef, final String objOrRole,
            final ObjectNameExpression obj, final Expression rhs, final ErrorCode... errors) {
        ErrorLog.getInstance().reset();
        LinkUnlinkExpression.create(null, LinkUnlinkExpression.LINK, lhs,
                RelationshipSpecification.createReference(lhs, relRef, objOrRole, obj, false, false), rhs);
