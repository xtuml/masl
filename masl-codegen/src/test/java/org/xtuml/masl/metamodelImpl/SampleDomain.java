...
public class SampleDomain {
    ...
    static {
        NormalRelationshipDeclaration.create(null, domain, "R1",
                HalfRelationship.create(refA, true, "to left of", MultiplicityType.ONE, refB),
                HalfRelationship.create(refB, true, "to right of", MultiplicityType.ONE, refA), new PragmaList());

        NormalRelationshipDeclaration.create(null, domain, "R2",
                HalfRelationship.create(refA, true, "to left of", MultiplicityType.MANY, refB),
                HalfRelationship.create(refB, true, "to right of", MultiplicityType.ONE, refA), new PragmaList());

        AssociativeRelationshipDeclaration.create(null, domain, "R3",
                HalfRelationship.create(refA, true, "to left of", MultiplicityType.ONE, refB),
                HalfRelationship.create(refB, true, "to right of", MultiplicityType.ONE, refA), refC, new PragmaList());

        AssociativeRelationshipDeclaration.create(null, domain, "R4",
                HalfRelationship.create(refA, true, "to left of", MultiplicityType.MANY, refB),
                HalfRelationship.create(refB, true, "to right of", MultiplicityType.ONE, refA), refD, new PragmaList());

        AssociativeRelationshipDeclaration.create(null, domain, "R5",
                HalfRelationship.create(refA, true, "to left of", MultiplicityType.MANY, refB),
                HalfRelationship.create(refB, true, "to right of", MultiplicityType.MANY, refA), refE,
                new PragmaList());

        AssociativeRelationshipDeclaration.create(null, domain, "R6",
                HalfRelationship.create(refA, true, "to left of", MultiplicityType.ONE, refB),
                HalfRelationship.create(refB, true, "to right of", MultiplicityType.ONE, refA), refF, new PragmaList());

        AssociativeRelationshipDeclaration.create(null, domain, "R7",
                HalfRelationship.create(refA, true, "to left of", MultiplicityType.MANY, refB),
                HalfRelationship.create(refB, true, "to right of", MultiplicityType.ONE, refA), refG, new PragmaList());

        AssociativeRelationshipDeclaration.create(null, domain, "R8",
                HalfRelationship.create(refA, true, "to left of", MultiplicityType.MANY, refB),
                HalfRelationship.create(refB, true, "to right of", MultiplicityType.MANY, refA), refH,
                new PragmaList());

        AttributeDeclaration.create(objA, "id", integer, true, false, new ArrayList<ReferentialAttributeDefinition>(),
                null, new PragmaList());
        AttributeDeclaration.create(objA, "non_id", integer, false, false,
                new ArrayList<ReferentialAttributeDefinition>(), null, new PragmaList());
        AttributeDeclaration.create(objB, "id", integer, true, false, new ArrayList<ReferentialAttributeDefinition>(),
                null, new PragmaList());
        AttributeDeclaration.create(objB, "non_id", integer, false, false,
                new ArrayList<ReferentialAttributeDefinition>(), null, new PragmaList());

        final ArrayList<ReferentialAttributeDefinition> refAttList_R1R2 = new ArrayList<>();
        refAttList_R1R2
                .add(ReferentialAttributeDefinition.create(objA,
                        RelationshipSpecification.createReference(new ObjectNameExpression(null, objB),
                                RelationshipDeclaration.createReference(domainRef, "R1"), "A", refA, false, false),
                        "id"));
        refAttList_R1R2
                .add(ReferentialAttributeDefinition.create(objA,
                        RelationshipSpecification.createReference(new ObjectNameExpression(null, objB),
                                RelationshipDeclaration.createReference(domainRef, "R2"), "A", refA, false, false),
                        "id"));
        AttributeDeclaration.create(objB, "a_id", integer, false, false, refAttList_R1R2, null, new PragmaList());

        final ArrayList<ReferentialAttributeDefinition> refAttList_R3A = new ArrayList<>();
        refAttList_R3A
                .add(ReferentialAttributeDefinition.create(objA,
                        RelationshipSpecification.createReference(new ObjectNameExpression(null, objC),
                                RelationshipDeclaration.createReference(domainRef, "R3"), "A", refA, false, false),
                        "id"));
        final ArrayList<ReferentialAttributeDefinition> refAttList_R3B = new ArrayList<>();
        refAttList_R3B
                .add(ReferentialAttributeDefinition.create(objA,
                        RelationshipSpecification.createReference(new ObjectNameExpression(null, objC),
                                RelationshipDeclaration.createReference(domainRef, "R3"), "B", refB, false, false),
                        "id"));
        ...
        AttributeDeclaration.create(objC, "non_id", integer, false, false,
                new ArrayList<ReferentialAttributeDefinition>(), null, new PragmaList());

        final ArrayList<ReferentialAttributeDefinition> refAttList_R4A = new ArrayList<>();
        refAttList_R4A
                .add(ReferentialAttributeDefinition.create(objA,
                        RelationshipSpecification.createReference(new ObjectNameExpression(null, objD),
                                RelationshipDeclaration.createReference(domainRef, "R4"), "A", refA, false, false),
                        "id"));
        final ArrayList<ReferentialAttributeDefinition> refAttList_R4B = new ArrayList<>();
        refAttList_R4B
                .add(ReferentialAttributeDefinition.create(objA,
                        RelationshipSpecification.createReference(new ObjectNameExpression(null, objD),
                                RelationshipDeclaration.createReference(domainRef, "R4"), "B", refB, false, false),
                        "id"));
        ...
        AttributeDeclaration.create(objD, "non_id", integer, false, false,
                new ArrayList<ReferentialAttributeDefinition>(), null, new PragmaList());

        final ArrayList<ReferentialAttributeDefinition> refAttList_R5A = new ArrayList<>();
        refAttList_R5A
                .add(ReferentialAttributeDefinition.create(objA,
                        RelationshipSpecification.createReference(new ObjectNameExpression(null, objE),
                                RelationshipDeclaration.createReference(domainRef, "R5"), "A", refA, false, false),
                        "id"));
        final ArrayList<ReferentialAttributeDefinition> refAttList_R5B = new ArrayList<>();
        refAttList_R5B
                .add(ReferentialAttributeDefinition.create(objA,
                        RelationshipSpecification.createReference(new ObjectNameExpression(null, objE),
                                RelationshipDeclaration.createReference(domainRef, "R5"), "B", refB, false, false),
                        "id"));
        ...
        AttributeDeclaration.create(objE, "non_id", integer, false, false,
                new ArrayList<ReferentialAttributeDefinition>(), null, new PragmaList());

        final ArrayList<ReferentialAttributeDefinition> refAttList_R6A = new ArrayList<>();
        refAttList_R6A
                .add(ReferentialAttributeDefinition.create(objA,
                        RelationshipSpecification.createReference(new ObjectNameExpression(null, objF),
                                RelationshipDeclaration.createReference(domainRef, "R6"), "A", refA, false, false),
                        "id"));
        final ArrayList<ReferentialAttributeDefinition> refAttList_R6B = new ArrayList<>();
        refAttList_R6B
                .add(ReferentialAttributeDefinition.create(objA,
                        RelationshipSpecification.createReference(new ObjectNameExpression(null, objF),
                                RelationshipDeclaration.createReference(domainRef, "R6"), "B", refB, false, false),
                        "id"));

        AttributeDeclaration.create(objF, "id", integer, true, false, new ArrayList<ReferentialAttributeDefinition>(),
                null, new PragmaList());
        ...
        AttributeDeclaration.create(objF, "non_id", integer, false, false,
                new ArrayList<ReferentialAttributeDefinition>(), null, new PragmaList());

        final ArrayList<ReferentialAttributeDefinition> refAttList_R7A = new ArrayList<>();
        refAttList_R7A
                .add(ReferentialAttributeDefinition.create(objA,
                        RelationshipSpecification.createReference(new ObjectNameExpression(null, objG),
                                RelationshipDeclaration.createReference(domainRef, "R7"), "A", refA, false, false),
                        "id"));
        final ArrayList<ReferentialAttributeDefinition> refAttList_R7B = new ArrayList<>();
        refAttList_R7B
                .add(ReferentialAttributeDefinition.create(objA,
                        RelationshipSpecification.createReference(new ObjectNameExpression(null, objG),
                                RelationshipDeclaration.createReference(domainRef, "R7"), "B", refB, false, false),
                        "id"));

        AttributeDeclaration.create(objG, "id", integer, true, false, new ArrayList<ReferentialAttributeDefinition>(),
                null, new PragmaList());
        ...
        AttributeDeclaration.create(objG, "non_id", integer, false, false,
                new ArrayList<ReferentialAttributeDefinition>(), null, new PragmaList());

        final ArrayList<ReferentialAttributeDefinition> refAttList_R8A = new ArrayList<>();
        refAttList_R8A
                .add(ReferentialAttributeDefinition.create(objA,
                        RelationshipSpecification.createReference(new ObjectNameExpression(null, objH),
                                RelationshipDeclaration.createReference(domainRef, "R8"), "A", refA, false, false),
                        "id"));
        final ArrayList<ReferentialAttributeDefinition> refAttList_R8B = new ArrayList<>();
        refAttList_R8B
                .add(ReferentialAttributeDefinition.create(objA,
                        RelationshipSpecification.createReference(new ObjectNameExpression(null, objH),
                                RelationshipDeclaration.createReference(domainRef, "R8"), "B", refB, false, false),
                        "id"));

        AttributeDeclaration.create(objH, "id", integer, true, false, new ArrayList<ReferentialAttributeDefinition>(),
                null, new PragmaList());
        ...
        AttributeDeclaration.create(objH, "non_id", integer, false, false,
                new ArrayList<ReferentialAttributeDefinition>(), null, new PragmaList());
    ...
    static public final VariableDefinition singleAdef = VariableDefinition.create("varA", singleAType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition singleBdef = VariableDefinition.create("varB", singleBType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition singleCdef = VariableDefinition.create("varC", singleCType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition singleDdef = VariableDefinition.create("varD", singleDType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition singleEdef = VariableDefinition.create("varE", singleEType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition singleFdef = VariableDefinition.create("varF", singleFType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition singleGdef = VariableDefinition.create("varG", singleGType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition singleHdef = VariableDefinition.create("varH", singleHType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition collAdef = VariableDefinition.create("collA", collAType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition collBdef = VariableDefinition.create("varB", collBType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition collCdef = VariableDefinition.create("collB", collCType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition collDdef = VariableDefinition.create("collB", collDType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition collEdef = VariableDefinition.create("collB", collEType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition collFdef = VariableDefinition.create("collF", collFType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition collGdef = VariableDefinition.create("collG", collGType, false, null,
            new PragmaList());
    ...
    static public final VariableDefinition collHdef = VariableDefinition.create("collH", collHType, false, null,
            new PragmaList());
