...
import org.xtuml.masl.translate.sql.main.TernaryRelationshipToTableTranslator;

import java.util.ArrayList;
import java.util.List;

public class SqliteTernaryRelationshipToTableTranslator implements TernaryRelationshipToTableTranslator {

    private final RelationshipDeclaration relationshipDecl;

    public SqliteTernaryRelationshipToTableTranslator(final RelationshipDeclaration relationshipDeclaration) {
    ...
    public PreparedStatement createPreparedStatement(final PreparedStatement.PreparedStatementType classification) {
        return new SqliteTernaryRelationshipPreparedStatement(this, classification);
    }

    @Override
    public void addLoadAllBody(final Function loadAllFn, final Variable cachedTernaryContVar) {
        // Create cpp line:
        // ::std::string query;
        final Expression
                queryText =
    ...
    public void addLoadLhsBody(final Function loadLhsFn,
                               ...
                               final Variable cachedTernaryContVar) {
        // Create cpp line:
    ...
    private void addCachedSetLinkBlock(final CodeBlock codeBlock,
        ...
        // Create cpp line:
        // cachedTernaryContainerSet.getLhsLinks()[lhsColumnValue].link(rhsColumnValue,assColumnValue);
        final Expression
                lhsLink =
        ...
        // Create cpp line:
        // cachedTernaryContainers.getRhsLinks()[lhsColumnValue].link(
        ...
        // Create cpp line:
        // cachedTernaryContainers.getAssLinks()[rhsColumnValue].link(
     ...
     * <p>
     * cachedTernaryContainerSet.getLhsLinks()[lhsColumnValue].link(rhsColumnValue,
     * assColumnValue);
     * <p>
     * <p>
    ...
    private Expression addCachedSetLinkExpression(final Function getLinksFn,
        ...
        // Create cpp line:
        // cachedTernaryContainerSet.getRhsToLhsLinks()[rhsColumnValue].link(lhsColumnValue);
