...
public final class Architecture {
    ...
    public static BuildSet buildSet = new BuildSet("xtuml_swa");

    public final static Library library = new ImportedLibrary("xtuml_swa").inBuildSet(buildSet);
    ...
    public static class DynamicSingleton {
        ...
        public DynamicSingleton(final Type templateParam) {
            ...
            getSingleton =
                    clazz.createStaticFunction(clazz.createDeclarationGroup(), "getSingleton", Visibility.PUBLIC);
    ...
    public static Class objectPtr(final TypeUsage pointee) {
    ...
    public static Class toOneRelationship(final TypeUsage related) {
    ...
    public static Class toManyRelationship(final TypeUsage related) {
    ...
    public static Class toManyAssociative(final TypeUsage related, final TypeUsage assoc) {
    ...
    public static Class toOneAssociative(final TypeUsage related, final TypeUsage assoc) {
    ...
    public static Class dictionary(final TypeUsage key, final TypeUsage value) {
    ...
    public static Class sequence(final TypeUsage of) {
    ...
    public static Class range(final TypeUsage of) {
    ...
    public static Class bag(final TypeUsage of) {
    ...
    public static Class set(final TypeUsage of) {
    ...
    public final static Function
            runService =
            processClass.createMemberFunction(processClass.createDeclarationGroup(), "runService", Visibility.PUBLIC);
    ...
    public static class Timer {
        ...
        public final static Expression
                createTimer =
                new Function("createTimer").asFunctionCall(timerClass.callStaticFunction("getInstance"), false);
        ...
        public final static Expression scheduleTimer(final Expression timerHandle,
            ...
            return new Function("scheduleTimer").asFunctionCall(instance,
                                                                false,
                                                                timerHandle,
                                                                timeOut,
                                                                period,
    ...
    public static Class createFunctionOverrider(final TypeUsage functionType) {
    ...
    public static Expression registerProcessListener(final String event, final Expression function, final boolean wrapCallback) {
        ...
        final Expression callback = !wrapCallback ? function : Boost.bind.asFunctionCall(
            runService.asFunctionPointer(), Boost.ref.asFunctionCall(process), function, Literal.EMPTY_STRING);
        return new Function(eventRegistrationFunctions.get(event)).asFunctionCall(process, false, callback);
    }

    public final static Class listenerConnection = Boost.signalConnection;

    public static Expression getDomain(final Expression domainName) {
        return new Function("getDomain").asFunctionCall(process, false, domainName);
    }

    public static Expression registerSignalHandler(final Expression signal, final Expression callback) {
        return new Function("addSignalCallback").asFunctionCall(activityMonitor, false, signal, callback);
    }

    public static Expression registerStartupService(final Expression callback) {
        return registerProcessListener("initialised", callback, true);
    }

    public static Expression getDomainId(final Expression domainName) {
    ...
    public static Class rangeIterator(final TypeUsage of) {
    ...
    public static Expression parse(final TypeUsage to, final Expression from) {
        final Function fn = new Function("parse", NAMESPACE, parseInc);
        fn.addTemplateSpecialisation(to);
        return fn.asFunctionCall(from);
    }

    public static Expression parseBased(final TypeUsage to, final Expression from, final Expression base) {
    ...
    public final static Function
            console =
            new Function("console", NAMESPACE, library.createInterfaceHeader("swa/console.hh"));

    public final static Type
            ID_TYPE =
            new TypedefType("IdType",
                            NAMESPACE,
    ...
    public final static Expression
            forceTruePredicate =
            new Function("forceTrue", NAMESPACE, collectionInc).asFunctionPointer();
    ...
    public static Expression transitioningState(final Expression domainId,
    ...
    public static Expression transitioningAssignerState(final Expression domainId,
                                                        final Expression objectId,
                                                        final Expression oldState,
                                                        final Expression newState) {
    ...
    private static final CodeFile nameFormatterInc = library.createInterfaceHeader("swa/NameFormatter.hh");
    private static final Class nameFormatter = new Class("NameFormatter", NAMESPACE, nameFormatterInc);

    public static Expression formatEventName(final Expression domainId,
                                             final Expression objectId,
                                             final Expression eventId) {
        return nameFormatter.callStaticFunction("formatEventName", domainId, objectId, eventId);
    }

    public static Expression formatStateActionName(final Expression domainId,
                                                   final Expression objectId,
    ...
    public static Function navigateMany(final TypeUsage destObj) {
        final Function fn = new Function("navigate_many", NAMESPACE, navigateInc);
        fn.addTemplateSpecialisation(destObj);
        return fn;
    }

    public static Function navigateOneBag(final TypeUsage destObj) {
        final Function fn = new Function("navigate_one_bag", NAMESPACE, navigateInc);
        fn.addTemplateSpecialisation(destObj);
        return fn;
    }

    public static Function navigateManyBag(final TypeUsage destObj) {
    ...
    public static class Event {
        ...
        private Event() {
            ...
            eventPtr = Std.shared_ptr(new TypeUsage(clazz));
        }
    ...
    public static class Logger {
        private final static BuildSet buildSet = new BuildSet("xtuml_logging");
        private final static Library loggingLib = new ImportedLibrary("xtuml_logging").inBuildSet(buildSet);
