 ...
 * <p>
 * As three objects take part in the relationship it is also known as a Ternary
 ...
 * provides the logic required to support the Ternary relationship class, it does
 ...
 * <p>
 * The TernaryRelationshipMapperSqlClass therefore provides the required
 * functionality to generate an implementation for the MapperSQL intefrace.
 */
public class TernaryRelationshipMapperSqlClass implements GeneratedRelationshipClass {
    ...
    TernaryRelationshipToTableTranslator tableTranslator;
     ...
     */
    public TernaryRelationshipMapperSqlClass(final RelationshipMapperClass parent,
        ...
        tableTranslator = databaseTraits.createTernaryRelationshipToTableTranslator(relationshipDecl);
    ...
    protected void addCommitMethods() {
        ...
        final Variable
                linkObjectsVar =
                commitLinkFn.createParameter(new TypeUsage(mapperSqlClass.referenceNestedType("LinkedTernaryType"),
        ...
        final Variable
                unlinkObjectsVar =
                commitUnlinkFn.createParameter(new TypeUsage(mapperSqlClass.referenceNestedType("LinkedTernaryType"),
    ...
    private void addLoadAll() {
        ...
        final Variable
                cachedTernaryContVar =
                loadAllFn.createParameter(new TypeUsage(mapperSqlClass.referenceNestedType("CachedTernaryContainerSet"),
                                                        TypeUsage.Reference), "cachedTernaryContainers");

        tableTranslator.addLoadAllBody(loadAllFn, cachedTernaryContVar);
    ...
    private void addLoadLhs() {
        ...
        final Variable
                cachedTernaryContVar =
                loadLhsFn.createParameter(new TypeUsage(mapperSqlClass.referenceNestedType("CachedTernaryContainerSet"),
                                                        TypeUsage.Reference), "cachedTernaryContainers");

        tableTranslator.addLoadLhsBody(loadLhsFn, rhsIdentityVar, cachedTernaryContVar);
    ...
    private void addLoadRhs() {
        ...
        final Variable
                cachedTernaryContVar =
                loadRhsFn.createParameter(new TypeUsage(mapperSqlClass.referenceNestedType("CachedTernaryContainerSet"),
                                                        TypeUsage.Reference), "cachedTernaryContainers");

        tableTranslator.addLoadRhsBody(loadRhsFn, lhsIdentityVar, cachedTernaryContVar);
    ...
    private void addLoadAss() {
        ...
        final Variable
                cachedTernaryContVar =
                loadAssFn.createParameter(new TypeUsage(mapperSqlClass.referenceNestedType("CachedTernaryContainerSet"),
                                                        TypeUsage.Reference), "cachedTernaryContainers");

        tableTranslator.addLoadRhsBody(loadAssFn, assIdentityVar, cachedTernaryContVar);
