...
public class Database {
    private final static BuildSet buildSet = new BuildSet("xtuml_sql");
    private static final Library sqllib = new ImportedLibrary("xtuml_sql").inBuildSet(buildSet);
    ...
    static public final CodeFile
            ...
            sqllib.createInterfaceHeader("sql/RelationshipTernaryDefinitions.hh");
    static public final CodeFile
