...
public class Architecture {
    ...
    private static final BuildSet buildSet = new BuildSet("xtuml_metadata");
    public static final Library metaDataLib = new ImportedLibrary("xtuml_metadata").inBuildSet(buildSet);
