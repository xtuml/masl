...
public class SqliteTernaryRelationshipPreparedStatement extends SqliteRelationshipPreparedStatement {

    private final SqliteTernaryRelationshipToTableTranslator tableTranslator;

    public SqliteTernaryRelationshipPreparedStatement(final SqliteTernaryRelationshipToTableTranslator tableTranslator,
