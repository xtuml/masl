...
public class CreateExpression extends Expression implements org.xtuml.masl.metamodel.expression.CreateExpression {
    ...
    public static class NormalAttribute extends CreateAggregateValue
        ...
        public static NormalAttribute create(final ObjectNameExpression objectName,
            ...
            try {
                return new NormalAttribute(Position.getPosition(attributeName),
                                           objectName.getObject().getAttribute(attributeName),
                                           value);
            } catch (final SemanticError e) {
                e.report();
                return null;
        ...
        public NormalAttribute(final Position position,
                               final AttributeDeclaration attribute,
                               final Expression value) throws SemanticError {
            super(position);
    ...
    private CreateExpression(final Position position,
        ...
        for (final AttributeDeclaration att : requiredIdentifiers) {
            new SemanticError(SemanticErrorCode.CreateIdentifierMissing,
                              position,
                              object.getName(),
                              att.getName()).report();
        }
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof CreateExpression obj2) {
