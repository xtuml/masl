...
public class Std {
    ...
    private final static Library system = new ImportedLibrary(null);
    ...
    private final static CodeFile functionalInc = system.createSystemHeader("functional");
    /**
    ...
    public static Function dynamic_pointer_cast(final TypeUsage type) {
        final Function dynamic_cast = new Function("dynamic_pointer_cast",std,memoryInc);
        dynamic_cast.addTemplateSpecialisation(type);
        return dynamic_cast;
    }
    ...
    public static Class function(final TypeUsage returnType, final List<TypeUsage> paramTypeList) {
        final Class ret = new Class("function", std, functionalInc);
